...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:vi,depthTest:!1,depthWrite:!1})}function $s(){return new yi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:as(),fragmentShader:`
		...
		`,blending:vi,depthTest:!1,depthWrite:!1})}function Qs(){return new yi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:as(),fragmentShader:`
...
`)+`
`+h);const E=b+f+s,T=b+h+o,I=oo(n,n.VERTEX_SHADER,E),R=oo(n,n.FRAGMENT_SHADER,T);n.attachShader(M,I),n.attachShader(M,R),t.index0AttributeName!==void 0?n.bindAttribLocation(M,0,t.index0AttributeName):t.morphTargets===!0&&n.bindAttribLocation(M,0,"position"),n.linkProgram(M);function A(P){if(r.debug.checkShaderErrors){const k=n.getProgramInfoLog(M).trim(),H=n.getShaderInfoLog(I).trim(),W=n.getShaderInfoLog(R).trim();let J=!0,V=!0;if(n.getProgramParameter(M,n.LINK_STATUS)===!1)if(J=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(n,M,I,R);else{const $=co(n,I,"vertex"),G=co(n,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+n.getError()+" - VALIDATE_STATUS "+n.getProgramParameter(M,n.VALIDATE_STATUS)+`
...
Program Info Log: `+k+`
`+$+`
`+G)}else k!==""?console.warn("THREE.WebGLProgram: Program Info Log:",k):(H===""||W==="")&&(V=!1);V&&(P.diagnostics={runnable:J,programLog:k,vertexShader:{log:H,prefix:f},fragmentShader:{log:W,prefix:h}})}n.deleteShader(I),n.deleteShader(R),N=new mn(n,M),y=Np(n,M)}let N;this.getUniforms=function(){return N===void 0&&A(this),N};let y;this.getAttributes=function(){return y===void 0&&A(this),y};let x=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return x===!1&&(x=n.getProgramParameter(M,wp)),x},this.destroy=function(){i.releaseStatesOfProgram(this),n.deleteProgram(M),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=Ap++,this.cacheKey=e,this.usedTimes=1,this.program=M,this.vertexShader=I,this.fragmentShader=R,this}let Yp=0;class qp{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,i=e.fragmentShader,n=this._getShaderStage(t),a=this._getShaderStage(i),s=this._getShaderCacheForMaterial(e);return s.has(n)===!1&&(s.add(n),n.usedTimes++),s.has(a)===!1&&(s.add(a),a.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const i of t)i.usedTimes--,i.usedTimes===0&&this.shaderCache.delete(i.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let i=t.get(e);return i===void 0&&(i=new Set,t.set(e,i)),i}_getShaderStage(e){const t=this.shaderCache;let i=t.get(e);return i===void 0&&(i=new Zp(e),t.set(e,i)),i}}class Zp{constructor(e){this.id=Yp++,this.code=e,this.usedTimes=0}}function Kp(r,e,t,i,n,a,s){const o=new Bo,l=new qp,c=new Set,u=[],p=n.logarithmicDepthBuffer,d=n.vertexTextures;let m=n.precision;const v={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function M(y){return c.add(y),y===0?"uv":`uv${y}`}function f(y,x,P,k,H){const W=k.fog,J=H.geometry,V=y.isMeshStandardMaterial?k.environment:null,$=(y.isMeshStandardMaterial?t:e).get(y.envMap||V),G=$&&$.mapping===Sn?$.image.height:null,te=v[y.type];y.precision!==null&&(m=n.getMaxPrecision(y.precision),m!==y.precision&&console.warn("THREE.WebGLProgram.getParameters:",y.precision,"not supported, using",m,"instead."));const pe=J.morphAttributes.position||J.morphAttributes.normal||J.morphAttributes.color,we=pe!==void 0?pe.length:0;let De=0;J.morphAttributes.position!==void 0&&(De=1),J.morphAttributes.normal!==void 0&&(De=2),J.morphAttributes.color!==void 0&&(De=3);let Ke,X,ee,me;if(te){const We=Yt[te];Ke=We.vertexShader,X=We.fragmentShader}else Ke=y.vertexShader,X=y.fragmentShader,l.update(y),ee=l.getVertexShaderID(y),me=l.getFragmentShaderID(y);const ae=r.getRenderTarget(),ye=r.state.buffers.depth.getReversed(),Ae=H.isInstancedMesh===!0,Ie=H.isBatchedMesh===!0,it=!!y.map,He=!!y.matcap,at=!!$,w=!!y.aoMap,Ct=!!y.lightMap,Oe=!!y.bumpMap,Fe=!!y.normalMap,ve=!!y.displacementMap,Qe=!!y.emissiveMap,_e=!!y.metalnessMap,S=!!y.roughnessMap,g=y.anisotropy>0,O=y.clearcoat>0,Y=y.dispersion>0,K=y.iridescence>0,j=y.sheen>0,ge=y.transmission>0,se=g&&!!y.anisotropyMap,de=O&&!!y.clearcoatMap,Ge=O&&!!y.clearcoatNormalMap,Q=O&&!!y.clearcoatRoughnessMap,he=K&&!!y.iridescenceMap,Me=K&&!!y.iridescenceThicknessMap,Se=j&&!!y.sheenColorMap,ue=j&&!!y.sheenRoughnessMap,ze=!!y.specularMap,Pe=!!y.specularColorMap,Je=!!y.specularIntensityMap,C=ge&&!!y.transmissionMap,ne=ge&&!!y.thicknessMap,B=!!y.gradientMap,q=!!y.alphaMap,oe=y.alphaTest>0,ie=!!y.alphaHash,Be=!!y.extensions;let rt=xi;y.toneMapped&&(ae===null||ae.isXRRenderTarget===!0)&&(rt=r.toneMapping);const ft={shaderID:te,shaderType:y.type,shaderName:y.name,vertexShader:Ke,fragmentShader:X,defines:y.defines,customVertexShaderID:ee,customFragmentShaderID:me,isRawShaderMaterial:y.isRawShaderMaterial===!0,glslVersion:y.glslVersion,precision:m,batching:Ie,batchingColor:Ie&&H._colorsTexture!==null,instancing:Ae,instancingColor:Ae&&H.instanceColor!==null,instancingMorph:Ae&&H.morphTexture!==null,supportsVertexTextures:d,outputColorSpace:ae===null?r.outputColorSpace:ae.isXRRenderTarget===!0?ae.texture.colorSpace:pr,alphaToCoverage:!!y.alphaToCoverage,map:it,matcap:He,envMap:at,envMapMode:at&&$.mapping,envMapCubeUVHeight:G,aoMap:w,lightMap:Ct,bumpMap:Oe,normalMap:Fe,displacementMap:d&&ve,emissiveMap:Qe,normalMapObjectSpace:Fe&&y.normalMapType===Hl,normalMapTangentSpace:Fe&&y.normalMapType===Io,metalnessMap:_e,roughnessMap:S,anisotropy:g,anisotropyMap:se,clearcoat:O,clearcoatMap:de,clearcoatNormalMap:Ge,clearcoatRoughnessMap:Q,dispersion:Y,iridescence:K,iridescenceMap:he,iridescenceThicknessMap:Me,sheen:j,sheenColorMap:Se,sheenRoughnessMap:ue,specularMap:ze,specularColorMap:Pe,specularIntensityMap:Je,transmission:ge,transmissionMap:C,thicknessMap:ne,gradientMap:B,opaque:y.transparent===!1&&y.blending===ar&&y.alphaToCoverage===!1,alphaMap:q,alphaTest:oe,alphaHash:ie,combine:y.combine,mapUv:it&&M(y.map.channel),aoMapUv:w&&M(y.aoMap.channel),lightMapUv:Ct&&M(y.lightMap.channel),bumpMapUv:Oe&&M(y.bumpMap.channel),normalMapUv:Fe&&M(y.normalMap.channel),displacementMapUv:ve&&M(y.displacementMap.channel),emissiveMapUv:Qe&&M(y.emissiveMap.channel),metalnessMapUv:_e&&M(y.metalnessMap.channel),roughnessMapUv:S&&M(y.roughnessMap.channel),anisotropyMapUv:se&&M(y.anisotropyMap.channel),clearcoatMapUv:de&&M(y.clearcoatMap.channel),clearcoatNormalMapUv:Ge&&M(y.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:Q&&M(y.clearcoatRoughnessMap.channel),iridescenceMapUv:he&&M(y.iridescenceMap.channel),iridescenceThicknessMapUv:Me&&M(y.iridescenceThicknessMap.channel),sheenColorMapUv:Se&&M(y.sheenColorMap.channel),sheenRoughnessMapUv:ue&&M(y.sheenRoughnessMap.channel),specularMapUv:ze&&M(y.specularMap.channel),specularColorMapUv:Pe&&M(y.specularColorMap.channel),specularIntensityMapUv:Je&&M(y.specularIntensityMap.channel),transmissionMapUv:C&&M(y.transmissionMap.channel),thicknessMapUv:ne&&M(y.thicknessMap.channel),alphaMapUv:q&&M(y.alphaMap.channel),vertexTangents:!!J.attributes.tangent&&(Fe||g),vertexColors:y.vertexColors,vertexAlphas:y.vertexColors===!0&&!!J.attributes.color&&J.attributes.color.itemSize===4,pointsUvs:H.isPoints===!0&&!!J.attributes.uv&&(it||q),fog:!!W,useFog:y.fog===!0,fogExp2:!!W&&W.isFogExp2,flatShading:y.flatShading===!0,sizeAttenuation:y.sizeAttenuation===!0,logarithmicDepthBuffer:p,reverseDepthBuffer:ye,skinning:H.isSkinnedMesh===!0,morphTargets:J.morphAttributes.position!==void 0,morphNormals:J.morphAttributes.normal!==void 0,morphColors:J.morphAttributes.color!==void 0,morphTargetsCount:we,morphTextureStride:De,numDirLights:x.directional.length,numPointLights:x.point.length,numSpotLights:x.spot.length,numSpotLightMaps:x.spotLightMap.length,numRectAreaLights:x.rectArea.length,numHemiLights:x.hemi.length,numDirLightShadows:x.directionalShadowMap.length,numPointLightShadows:x.pointShadowMap.length,numSpotLightShadows:x.spotShadowMap.length,numSpotLightShadowsWithMaps:x.numSpotLightShadowsWithMaps,numLightProbes:x.numLightProbes,numClippingPlanes:s.numPlanes,numClipIntersection:s.numIntersection,dithering:y.dithering,shadowMapEnabled:r.shadowMap.enabled&&P.length>0,shadowMapType:r.shadowMap.type,toneMapping:rt,decodeVideoTexture:it&&y.map.isVideoTexture===!0&&Ve.getTransfer(y.map.colorSpace)===Ye,decodeVideoTextureEmissive:Qe&&y.emissiveMap.isVideoTexture===!0&&Ve.getTransfer(y.emissiveMap.colorSpace)===Ye,premultipliedAlpha:y.premultipliedAlpha,doubleSided:y.side===si,flipSided:y.side===Tt,useDepthPacking:y.depthPacking>=0,depthPacking:y.depthPacking||0,index0AttributeName:y.index0AttributeName,extensionClipCullDistance:Be&&y.extensions.clipCullDistance===!0&&i.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(Be&&y.extensions.multiDraw===!0||Ie)&&i.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:i.has("KHR_parallel_shader_compile"),customProgramCacheKey:y.customProgramCacheKey()};return ft.vertexUv1s=c.has(1),ft.vertexUv2s=c.has(2),ft.vertexUv3s=c.has(3),c.clear(),ft}function h(y){const x=[];if(y.shaderID?x.push(y.shaderID):(x.push(y.customVertexShaderID),x.push(y.customFragmentShaderID)),y.defines!==void 0)for(const P in y.defines)x.push(P),x.push(y.defines[P]);return y.isRawShaderMaterial===!1&&(b(x,y),E(x,y),x.push(r.outputColorSpace)),x.push(y.customProgramCacheKey),x.join()}function b(y,x){y.push(x.precision),y.push(x.outputColorSpace),y.push(x.envMapMode),y.push(x.envMapCubeUVHeight),y.push(x.mapUv),y.push(x.alphaMapUv),y.push(x.lightMapUv),y.push(x.aoMapUv),y.push(x.bumpMapUv),y.push(x.normalMapUv),y.push(x.displacementMapUv),y.push(x.emissiveMapUv),y.push(x.metalnessMapUv),y.push(x.roughnessMapUv),y.push(x.anisotropyMapUv),y.push(x.clearcoatMapUv),y.push(x.clearcoatNormalMapUv),y.push(x.clearcoatRoughnessMapUv),y.push(x.iridescenceMapUv),y.push(x.iridescenceThicknessMapUv),y.push(x.sheenColorMapUv),y.push(x.sheenRoughnessMapUv),y.push(x.specularMapUv),y.push(x.specularColorMapUv),y.push(x.specularIntensityMapUv),y.push(x.transmissionMapUv),y.push(x.thicknessMapUv),y.push(x.combine),y.push(x.fogExp2),y.push(x.sizeAttenuation),y.push(x.morphTargetsCount),y.push(x.morphAttributeCount),y.push(x.numDirLights),y.push(x.numPointLights),y.push(x.numSpotLights),y.push(x.numSpotLightMaps),y.push(x.numHemiLights),y.push(x.numRectAreaLights),y.push(x.numDirLightShadows),y.push(x.numPointLightShadows),y.push(x.numSpotLightShadows),y.push(x.numSpotLightShadowsWithMaps),y.push(x.numLightProbes),y.push(x.shadowMapType),y.push(x.toneMapping),y.push(x.numClippingPlanes),y.push(x.numClipIntersection),y.push(x.depthPacking)}function E(y,x){o.disableAll(),x.supportsVertexTextures&&o.enable(0),x.instancing&&o.enable(1),x.instancingColor&&o.enable(2),x.instancingMorph&&o.enable(3),x.matcap&&o.enable(4),x.envMap&&o.enable(5),x.normalMapObjectSpace&&o.enable(6),x.normalMapTangentSpace&&o.enable(7),x.clearcoat&&o.enable(8),x.iridescence&&o.enable(9),x.alphaTest&&o.enable(10),x.vertexColors&&o.enable(11),x.vertexAlphas&&o.enable(12),x.vertexUv1s&&o.enable(13),x.vertexUv2s&&o.enable(14),x.vertexUv3s&&o.enable(15),x.vertexTangents&&o.enable(16),x.anisotropy&&o.enable(17),x.alphaHash&&o.enable(18),x.batching&&o.enable(19),x.dispersion&&o.enable(20),x.batchingColor&&o.enable(21),y.push(o.mask),o.disableAll(),x.fog&&o.enable(0),x.useFog&&o.enable(1),x.flatShading&&o.enable(2),x.logarithmicDepthBuffer&&o.enable(3),x.reverseDepthBuffer&&o.enable(4),x.skinning&&o.enable(5),x.morphTargets&&o.enable(6),x.morphNormals&&o.enable(7),x.morphColors&&o.enable(8),x.premultipliedAlpha&&o.enable(9),x.shadowMapEnabled&&o.enable(10),x.doubleSided&&o.enable(11),x.flipSided&&o.enable(12),x.useDepthPacking&&o.enable(13),x.dithering&&o.enable(14),x.transmission&&o.enable(15),x.sheen&&o.enable(16),x.opaque&&o.enable(17),x.pointsUvs&&o.enable(18),x.decodeVideoTexture&&o.enable(19),x.decodeVideoTextureEmissive&&o.enable(20),x.alphaToCoverage&&o.enable(21),y.push(o.mask)}function T(y){const x=v[y.type];let P;if(x){const k=Yt[x];P=vc.clone(k.uniforms)}else P=y.uniforms;return P}function I(y,x){let P;for(let k=0,H=u.length;k<H;k++){const W=u[k];if(W.cacheKey===x){P=W,++P.usedTimes;break}}return P===void 0&&(P=new jp(r,x,y,a),u.push(P)),P}function R(y){if(--y.usedTimes===0){const x=u.indexOf(y);u[x]=u[u.length-1],u.pop(),y.destroy()}}function A(y){l.remove(y)}function N(){l.dispose()}return{getParameters:f,getProgramCacheKey:h,getUniforms:T,acquireProgram:I,releaseProgram:R,releaseShaderCache:A,programs:u,dispose:N}}function Jp(){let r=new WeakMap;function e(s){return r.has(s)}function t(s){let o=r.get(s);return o===void 0&&(o={},r.set(s,o)),o}function i(s){r.delete(s)}function n(s,o,l){r.get(s)[o]=l}function a(){r=new WeakMap}return{has:e,get:t,remove:i,update:n,dispose:a}}function $p(r,e){return r.groupOrder!==e.groupOrder?r.groupOrder-e.groupOrder:r.renderOrder!==e.renderOrder?r.renderOrder-e.renderOrder:r.material.id!==e.material.id?r.material.id-e.material.id:r.z!==e.z?r.z-e.z:r.id-e.id}function mo(r,e){return r.groupOrder!==e.groupOrder?r.groupOrder-e.groupOrder:r.renderOrder!==e.renderOrder?r.renderOrder-e.renderOrder:r.z!==e.z?e.z-r.z:r.id-e.id}function go(){const r=[];let e=0;const t=[],i=[],n=[];function a(){e=0,t.length=0,i.length=0,n.length=0}function s(p,d,m,v,M,f){let h=r[e];return h===void 0?(h={id:p.id,object:p,geometry:d,material:m,groupOrder:v,renderOrder:p.renderOrder,z:M,group:f},r[e]=h):(h.id=p.id,h.object=p,h.geometry=d,h.material=m,h.groupOrder=v,h.renderOrder=p.renderOrder,h.z=M,h.group=f),e++,h}function o(p,d,m,v,M,f){const h=s(p,d,m,v,M,f);m.transmission>0?i.push(h):m.transparent===!0?n.push(h):t.push(h)}function l(p,d,m,v,M,f){const h=s(p,d,m,v,M,f);m.transmission>0?i.unshift(h):m.transparent===!0?n.unshift(h):t.unshift(h)}function c(p,d){t.length>1&&t.sort(p||$p),i.length>1&&i.sort(d||mo),n.length>1&&n.sort(d||mo)}function u(){for(let p=e,d=r.length;p<d;p++){const m=r[p];if(m.id===null)break;m.id=null,m.object=null,m.geometry=null,m.material=null,m.group=null}}return{opaque:t,transmissive:i,transparent:n,init:a,push:o,unshift:l,finish:u,sort:c}}function Qp(){let r=new WeakMap;function e(i,n){const a=r.get(i);let s;return a===void 0?(s=new go,r.set(i,[s])):n>=a.length?(s=new go,a.push(s)):s=a[n],s}function t(){r=new WeakMap}return{get:e,dispose:t}}function ef(){const r={};return{get:function(e){if(r[e.id]!==void 0)return r[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new D,color:new Ue};break;case"SpotLight":t={position:new D,direction:new D,color:new Ue,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new D,color:new Ue,distance:0,decay:0};break;case"HemisphereLight":t={direction:new D,skyColor:new Ue,groundColor:new Ue};break;case"RectAreaLight":t={color:new Ue,position:new D,halfWidth:new D,halfHeight:new D};break}return r[e.id]=t,t}}}function tf(){const r={};return{get:function(e){if(r[e.id]!==void 0)return r[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Re};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Re};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Re,shadowCameraNear:1,shadowCameraFar:1e3};break}return r[e.id]=t,t}}}let rf=0;function nf(r,e){return(e.castShadow?2:0)-(r.castShadow?2:0)+(e.map?1:0)-(r.map?1:0)}function af(r){const e=new ef,t=tf(),i={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)i.probe.push(new D);const n=new D,a=new tt,s=new tt;function o(c){let u=0,p=0,d=0;for(let y=0;y<9;y++)i.probe[y].set(0,0,0);let m=0,v=0,M=0,f=0,h=0,b=0,E=0,T=0,I=0,R=0,A=0;c.sort(nf);for(let y=0,x=c.length;y<x;y++){const P=c[y],k=P.color,H=P.intensity,W=P.distance,J=P.shadow&&P.shadow.map?P.shadow.map.texture:null;if(P.isAmbientLight)u+=k.r*H,p+=k.g*H,d+=k.b*H;else if(P.isLightProbe){for(let V=0;V<9;V++)i.probe[V].addScaledVector(P.sh.coefficients[V],H);A++}else if(P.isDirectionalLight){const V=e.get(P);if(V.color.copy(P.color).multiplyScalar(P.intensity),P.castShadow){const $=P.shadow,G=t.get(P);G.shadowIntensity=$.intensity,G.shadowBias=$.bias,G.shadowNormalBias=$.normalBias,G.shadowRadius=$.radius,G.shadowMapSize=$.mapSize,i.directionalShadow[m]=G,i.directionalShadowMap[m]=J,i.directionalShadowMatrix[m]=P.shadow.matrix,b++}i.directional[m]=V,m++}else if(P.isSpotLight){const V=e.get(P);V.position.setFromMatrixPosition(P.matrixWorld),V.color.copy(k).multiplyScalar(H),V.distance=W,V.coneCos=Math.cos(P.angle),V.penumbraCos=Math.cos(P.angle*(1-P.penumbra)),V.decay=P.decay,i.spot[M]=V;const $=P.shadow;if(P.map&&(i.spotLightMap[I]=P.map,I++,$.updateMatrices(P),P.castShadow&&R++),i.spotLightMatrix[M]=$.matrix,P.castShadow){const G=t.get(P);G.shadowIntensity=$.intensity,G.shadowBias=$.bias,G.shadowNormalBias=$.normalBias,G.shadowRadius=$.radius,G.shadowMapSize=$.mapSize,i.spotShadow[M]=G,i.spotShadowMap[M]=J,T++}M++}else if(P.isRectAreaLight){const V=e.get(P);V.color.copy(k).multiplyScalar(H),V.halfWidth.set(P.width*.5,0,0),V.halfHeight.set(0,P.height*.5,0),i.rectArea[f]=V,f++}else if(P.isPointLight){const V=e.get(P);if(V.color.copy(P.color).multiplyScalar(P.intensity),V.distance=P.distance,V.decay=P.decay,P.castShadow){const $=P.shadow,G=t.get(P);G.shadowIntensity=$.intensity,G.shadowBias=$.bias,G.shadowNormalBias=$.normalBias,G.shadowRadius=$.radius,G.shadowMapSize=$.mapSize,G.shadowCameraNear=$.camera.near,G.shadowCameraFar=$.camera.far,i.pointShadow[v]=G,i.pointShadowMap[v]=J,i.pointShadowMatrix[v]=P.shadow.matrix,E++}i.point[v]=V,v++}else if(P.isHemisphereLight){const V=e.get(P);V.skyColor.copy(P.color).multiplyScalar(H),V.groundColor.copy(P.groundColor).multiplyScalar(H),i.hemi[h]=V,h++}}f>0&&(r.has("OES_texture_float_linear")===!0?(i.rectAreaLTC1=re.LTC_FLOAT_1,i.rectAreaLTC2=re.LTC_FLOAT_2):(i.rectAreaLTC1=re.LTC_HALF_1,i.rectAreaLTC2=re.LTC_HALF_2)),i.ambient[0]=u,i.ambient[1]=p,i.ambient[2]=d;const N=i.hash;(N.directionalLength!==m||N.pointLength!==v||N.spotLength!==M||N.rectAreaLength!==f||N.hemiLength!==h||N.numDirectionalShadows!==b||N.numPointShadows!==E||N.numSpotShadows!==T||N.numSpotMaps!==I||N.numLightProbes!==A)&&(i.directional.length=m,i.spot.length=M,i.rectArea.length=f,i.point.length=v,i.hemi.length=h,i.directionalShadow.length=b,i.directionalShadowMap.length=b,i.pointShadow.length=E,i.pointShadowMap.length=E,i.spotShadow.length=T,i.spotShadowMap.length=T,i.directionalShadowMatrix.length=b,i.pointShadowMatrix.length=E,i.spotLightMatrix.length=T+I-R,i.spotLightMap.length=I,i.numSpotLightShadowsWithMaps=R,i.numLightProbes=A,N.directionalLength=m,N.pointLength=v,N.spotLength=M,N.rectAreaLength=f,N.hemiLength=h,N.numDirectionalShadows=b,N.numPointShadows=E,N.numSpotShadows=T,N.numSpotMaps=I,N.numLightProbes=A,i.version=rf++)}function l(c,u){let p=0,d=0,m=0,v=0,M=0;const f=u.matrixWorldInverse;for(let h=0,b=c.length;h<b;h++){const E=c[h];if(E.isDirectionalLight){const T=i.directional[p];T.direction.setFromMatrixPosition(E.matrixWorld),n.setFromMatrixPosition(E.target.matrixWorld),T.direction.sub(n),T.direction.transformDirection(f),p++}else if(E.isSpotLight){const T=i.spot[m];T.position.setFromMatrixPosition(E.matrixWorld),T.position.applyMatrix4(f),T.direction.setFromMatrixPosition(E.matrixWorld),n.setFromMatrixPosition(E.target.matrixWorld),T.direction.sub(n),T.direction.transformDirection(f),m++}else if(E.isRectAreaLight){const T=i.rectArea[v];T.position.setFromMatrixPosition(E.matrixWorld),T.position.applyMatrix4(f),s.identity(),a.copy(E.matrixWorld),a.premultiply(f),s.extractRotation(a),T.halfWidth.set(E.width*.5,0,0),T.halfHeight.set(0,E.height*.5,0),T.halfWidth.applyMatrix4(s),T.halfHeight.applyMatrix4(s),v++}else if(E.isPointLight){const T=i.point[d];T.position.setFromMatrixPosition(E.matrixWorld),T.position.applyMatrix4(f),d++}else if(E.isHemisphereLight){const T=i.hemi[M];T.direction.setFromMatrixPosition(E.matrixWorld),T.direction.transformDirection(f),M++}}}return{setup:o,setupView:l,state:i}}function _o(r){const e=new af(r),t=[],i=[];function n(u){c.camera=u,t.length=0,i.length=0}function a(u){t.push(u)}function s(u){i.push(u)}function o(){e.setup(t)}function l(u){e.setupView(t,u)}const c={lightsArray:t,shadowsArray:i,camera:null,lights:e,transmissionRenderTarget:{}};return{init:n,state:c,setupLights:o,setupLightsView:l,pushLight:a,pushShadow:s}}function sf(r){let e=new WeakMap;function t(n,a=0){const s=e.get(n);let o;return s===void 0?(o=new _o(r),e.set(n,[o])):a>=s.length?(o=new _o(r),s.push(o)):o=s[a],o}function i(){e=new WeakMap}return{get:t,dispose:i}}const of=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;class gf{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t,i){if(this.texture===null){const n=new Et,a=e.properties.get(n);a.__webglTexture=t.texture,(t.depthNear!==i.depthNear||t.depthFar!==i.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,i=new yi({vertexShader:ff,fragmentShader:mf,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Wt(new Ir(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class _f extends Bi{constructor(e,t){super();const i=this;let n=null,a=1,s=null,o="local-floor",l=1,c=null,u=null,p=null,d=null,m=null,v=null;const M=new gf,f=t.getContextAttributes();let h=null,b=null;const E=[],T=[],I=new Re;let R=null;const A=new Rt;A.viewport=new Ze;const N=new Rt;N.viewport=new Ze;const y=[A,N],x=new Nc;let P=null,k=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(X){let ee=E[X];return ee===void 0&&(ee=new qn,E[X]=ee),ee.getTargetRaySpace()},this.getControllerGrip=function(X){let ee=E[X];return ee===void 0&&(ee=new qn,E[X]=ee),ee.getGripSpace()},this.getHand=function(X){let ee=E[X];return ee===void 0&&(ee=new qn,E[X]=ee),ee.getHandSpace()};function H(X){const ee=T.indexOf(X.inputSource);if(ee===-1)return;const me=E[ee];me!==void 0&&(me.update(X.inputSource,X.frame,c||s),me.dispatchEvent({type:X.type,data:X.inputSource}))}function W(){n.removeEventListener("select",H),n.removeEventListener("selectstart",H),n.removeEventListener("selectend",H),n.removeEventListener("squeeze",H),n.removeEventListener("squeezestart",H),n.removeEventListener("squeezeend",H),n.removeEventListener("end",W),n.removeEventListener("inputsourceschange",J);for(let X=0;X<E.length;X++){const ee=T[X];ee!==null&&(T[X]=null,E[X].disconnect(ee))}P=null,k=null,M.reset(),e.setRenderTarget(h),m=null,d=null,p=null,n=null,b=null,Ke.stop(),i.isPresenting=!1,e.setPixelRatio(R),e.setSize(I.width,I.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(X){a=X,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(X){o=X,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||s},this.setReferenceSpace=function(X){c=X},this.getBaseLayer=function(){return d!==null?d:m},this.getBinding=function(){return p},this.getFrame=function(){return v},this.getSession=function(){return n},this.setSession=async function(X){if(n=X,n!==null){if(h=e.getRenderTarget(),n.addEventListener("select",H),n.addEventListener("selectstart",H),n.addEventListener("selectend",H),n.addEventListener("squeeze",H),n.addEventListener("squeezestart",H),n.addEventListener("squeezeend",H),n.addEventListener("end",W),n.addEventListener("inputsourceschange",J),f.xrCompatible!==!0&&await t.makeXRCompatible(),R=e.getPixelRatio(),e.getSize(I),typeof XRWebGLBinding<"u"&&"createProjectionLayer"in XRWebGLBinding.prototype){let ee=null,me=null,ae=null;f.depth&&(ae=f.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,ee=f.stencil?dr:sr,me=f.stencil?ur:Oi);const ye={colorFormat:t.RGBA8,depthFormat:ae,scaleFactor:a};p=new XRWebGLBinding(n,t),d=p.createProjectionLayer(ye),n.updateRenderState({layers:[d]}),e.setPixelRatio(1),e.setSize(d.textureWidth,d.textureHeight,!1),b=new Fi(d.textureWidth,d.textureHeight,{format:Vt,type:ci,depthTexture:new Yo(d.textureWidth,d.textureHeight,me,void 0,void 0,void 0,void 0,void 0,void 0,ee),stencilBuffer:f.stencil,colorSpace:e.outputColorSpace,samples:f.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1})}else{const ee={antialias:f.antialias,alpha:!0,depth:f.depth,stencil:f.stencil,framebufferScaleFactor:a};m=new XRWebGLLayer(n,t,ee),n.updateRenderState({baseLayer:m}),e.setPixelRatio(1),e.setSize(m.framebufferWidth,m.framebufferHeight,!1),b=new Fi(m.framebufferWidth,m.framebufferHeight,{format:Vt,type:ci,colorSpace:e.outputColorSpace,stencilBuffer:f.stencil})}b.isXRRenderTarget=!0,this.setFoveation(l),c=null,s=await n.requestReferenceSpace(o),Ke.setContext(n),Ke.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(n!==null)return n.environmentBlendMode},this.getDepthTexture=function(){return M.getDepthTexture()};function J(X){for(let ee=0;ee<X.removed.length;ee++){const me=X.removed[ee],ae=T.indexOf(me);ae>=0&&(T[ae]=null,E[ae].disconnect(me))}for(let ee=0;ee<X.added.length;ee++){const me=X.added[ee];let ae=T.indexOf(me);if(ae===-1){for(let Ae=0;Ae<E.length;Ae++)if(Ae>=T.length){T.push(me),ae=Ae;break}else if(T[Ae]===null){T[Ae]=me,ae=Ae;break}if(ae===-1)break}const ye=E[ae];ye&&ye.connect(me)}}const V=new D,$=new D;function G(X,ee,me){V.setFromMatrixPosition(ee.matrixWorld),$.setFromMatrixPosition(me.matrixWorld);const ae=V.distanceTo($),ye=ee.projectionMatrix.elements,Ae=me.projectionMatrix.elements,Ie=ye[14]/(ye[10]-1),it=ye[14]/(ye[10]+1),He=(ye[9]+1)/ye[5],at=(ye[9]-1)/ye[5],w=(ye[8]-1)/ye[0],Ct=(Ae[8]+1)/Ae[0],Oe=Ie*w,Fe=Ie*Ct,ve=ae/(-w+Ct),Qe=ve*-w;if(ee.matrixWorld.decompose(X.position,X.quaternion,X.scale),X.translateX(Qe),X.translateZ(ve),X.matrixWorld.compose(X.position,X.quaternion,X.scale),X.matrixWorldInverse.copy(X.matrixWorld).invert(),ye[10]===-1)X.projectionMatrix.copy(ee.projectionMatrix),X.projectionMatrixInverse.copy(ee.projectionMatrixInverse);else{const _e=Ie+ve,S=it+ve,g=Oe-Qe,O=Fe+(ae-Qe),Y=He*it/S*_e,K=at*it/S*_e;X.projectionMatrix.makePerspective(g,O,Y,K,_e,S),X.projectionMatrixInverse.copy(X.projectionMatrix).invert()}}function te(X,ee){ee===null?X.matrixWorld.copy(X.matrix):X.matrixWorld.multiplyMatrices(ee.matrixWorld,X.matrix),X.matrixWorldInverse.copy(X.matrixWorld).invert()}this.updateCamera=function(X){if(n===null)return;let ee=X.near,me=X.far;M.texture!==null&&(M.depthNear>0&&(ee=M.depthNear),M.depthFar>0&&(me=M.depthFar)),x.near=N.near=A.near=ee,x.far=N.far=A.far=me,(P!==x.near||k!==x.far)&&(n.updateRenderState({depthNear:x.near,depthFar:x.far}),P=x.near,k=x.far),A.layers.mask=X.layers.mask|2,N.layers.mask=X.layers.mask|4,x.layers.mask=A.layers.mask|N.layers.mask;const ae=X.parent,ye=x.cameras;te(x,ae);for(let Ae=0;Ae<ye.length;Ae++)te(ye[Ae],ae);ye.length===2?G(x,A,N):x.projectionMatrix.copy(A.projectionMatrix),pe(X,x,ae)};function pe(X,ee,me){me===null?X.matrix.copy(ee.matrixWorld):(X.matrix.copy(me.matrixWorld),X.matrix.invert(),X.matrix.multiply(ee.matrixWorld)),X.matrix.decompose(X.position,X.quaternion,X.scale),X.updateMatrixWorld(!0),X.projectionMatrix.copy(ee.projectionMatrix),X.projectionMatrixInverse.copy(ee.projectionMatrixInverse),X.isPerspectiveCamera&&(X.fov=ja*2*Math.atan(1/X.projectionMatrix.elements[5]),X.zoom=1)}this.getCamera=function(){return x},this.getFoveation=function(){if(!(d===null&&m===null))return l},this.setFoveation=function(X){l=X,d!==null&&(d.fixedFoveation=X),m!==null&&m.fixedFoveation!==void 0&&(m.fixedFoveation=X)},this.hasDepthSensing=function(){return M.texture!==null},this.getDepthSensingMesh=function(){return M.getMesh(x)};let we=null;function De(X,ee){if(u=ee.getViewerPose(c||s),v=ee,u!==null){const me=u.views;m!==null&&(e.setRenderTargetFramebuffer(b,m.framebuffer),e.setRenderTarget(b));let ae=!1;me.length!==x.cameras.length&&(x.cameras.length=0,ae=!0);for(let Ae=0;Ae<me.length;Ae++){const Ie=me[Ae];let it=null;if(m!==null)it=m.getViewport(Ie);else{const at=p.getViewSubImage(d,Ie);it=at.viewport,Ae===0&&(e.setRenderTargetTextures(b,at.colorTexture,d.ignoreDepthValues?void 0:at.depthStencilTexture),e.setRenderTarget(b))}let He=y[Ae];He===void 0&&(He=new Rt,He.layers.enable(Ae),He.viewport=new Ze,y[Ae]=He),He.matrix.fromArray(Ie.transform.matrix),He.matrix.decompose(He.position,He.quaternion,He.scale),He.projectionMatrix.fromArray(Ie.projectionMatrix),He.projectionMatrixInverse.copy(He.projectionMatrix).invert(),He.viewport.set(it.x,it.y,it.width,it.height),Ae===0&&(x.matrix.copy(He.matrix),x.matrix.decompose(x.position,x.quaternion,x.scale)),ae===!0&&x.cameras.push(He)}const ye=n.enabledFeatures;if(ye&&ye.includes("depth-sensing")&&n.depthUsage=="gpu-optimized"&&p){const Ae=p.getDepthInformation(me[0]);Ae&&Ae.isValid&&Ae.texture&&M.init(e,Ae,n.renderState)}}for(let me=0;me<E.length;me++){const ae=T[me],ye=E[me];ae!==null&&ye!==void 0&&ye.update(ae,ee,c||s)}we&&we(X,ee),ee.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:ee}),v=null}const Ke=new Zo;Ke.setAnimationLoop(De),this.setAnimationLoop=function(X){we=X},this.dispose=function(){}}}const Pi=new $t,vf=new tt;function xf(r,e){function t(f,h){f.matrixAutoUpdate===!0&&f.updateMatrix(),h.value.copy(f.matrix)}function i(f,h){h.color.getRGB(f.fogColor.value,Wo(r)),h.isFog?(f.fogNear.value=h.near,f.fogFar.value=h.far):h.isFogExp2&&(f.fogDensity.value=h.density)}function n(f,h,b,E,T){h.isMeshBasicMaterial||h.isMeshLambertMaterial?a(f,h):h.isMeshToonMaterial?(a(f,h),p(f,h)):h.isMeshPhongMaterial?(a(f,h),u(f,h)):h.isMeshStandardMaterial?(a(f,h),d(f,h),h.isMeshPhysicalMaterial&&m(f,h,T)):h.isMeshMatcapMaterial?(a(f,h),v(f,h)):h.isMeshDepthMaterial?a(f,h):h.isMeshDistanceMaterial?(a(f,h),M(f,h)):h.isMeshNormalMaterial?a(f,h):h.isLineBasicMaterial?(s(f,h),h.isLineDashedMaterial&&o(f,h)):h.isPointsMaterial?l(f,h,b,E):h.isSpriteMaterial?c(f,h):h.isShadowMaterial?(f.color.value.copy(h.color),f.opacity.value=h.opacity):h.isShaderMaterial&&(h.uniformsNeedUpdate=!1)}function a(f,h){f.opacity.value=h.opacity,h.color&&f.diffuse.value.copy(h.color),h.emissive&&f.emissive.value.copy(h.emissive).multiplyScalar(h.emissiveIntensity),h.map&&(f.map.value=h.map,t(h.map,f.mapTransform)),h.alphaMap&&(f.alphaMap.value=h.alphaMap,t(h.alphaMap,f.alphaMapTransform)),h.bumpMap&&(f.bumpMap.value=h.bumpMap,t(h.bumpMap,f.bumpMapTransform),f.bumpScale.value=h.bumpScale,h.side===Tt&&(f.bumpScale.value*=-1)),h.normalMap&&(f.normalMap.value=h.normalMap,t(h.normalMap,f.normalMapTransform),f.normalScale.value.copy(h.normalScale),h.side===Tt&&f.normalScale.value.negate()),h.displacementMap&&(f.displacementMap.value=h.displacementMap,t(h.displacementMap,f.displacementMapTransform),f.displacementScale.value=h.displacementScale,f.displacementBias.value=h.displacementBias),h.emissiveMap&&(f.emissiveMap.value=h.emissiveMap,t(h.emissiveMap,f.emissiveMapTransform)),h.specularMap&&(f.specularMap.value=h.specularMap,t(h.specularMap,f.specularMapTransform)),h.alphaTest>0&&(f.alphaTest.value=h.alphaTest);const b=e.get(h),E=b.envMap,T=b.envMapRotation;E&&(f.envMap.value=E,Pi.copy(T),Pi.x*=-1,Pi.y*=-1,Pi.z*=-1,E.isCubeTexture&&E.isRenderTargetTexture===!1&&(Pi.y*=-1,Pi.z*=-1),f.envMapRotation.value.setFromMatrix4(vf.makeRotationFromEuler(Pi)),f.flipEnvMap.value=E.isCubeTexture&&E.isRenderTargetTexture===!1?-1:1,f.reflectivity.value=h.reflectivity,f.ior.value=h.ior,f.refractionRatio.value=h.refractionRatio),h.lightMap&&(f.lightMap.value=h.lightMap,f.lightMapIntensity.value=h.lightMapIntensity,t(h.lightMap,f.lightMapTransform)),h.aoMap&&(f.aoMap.value=h.aoMap,f.aoMapIntensity.value=h.aoMapIntensity,t(h.aoMap,f.aoMapTransform))}function s(f,h){f.diffuse.value.copy(h.color),f.opacity.value=h.opacity,h.map&&(f.map.value=h.map,t(h.map,f.mapTransform))}function o(f,h){f.dashSize.value=h.dashSize,f.totalSize.value=h.dashSize+h.gapSize,f.scale.value=h.scale}function l(f,h,b,E){f.diffuse.value.copy(h.color),f.opacity.value=h.opacity,f.size.value=h.size*b,f.scale.value=E*.5,h.map&&(f.map.value=h.map,t(h.map,f.uvTransform)),h.alphaMap&&(f.alphaMap.value=h.alphaMap,t(h.alphaMap,f.alphaMapTransform)),h.alphaTest>0&&(f.alphaTest.value=h.alphaTest)}function c(f,h){f.diffuse.value.copy(h.color),f.opacity.value=h.opacity,f.rotation.value=h.rotation,h.map&&(f.map.value=h.map,t(h.map,f.mapTransform)),h.alphaMap&&(f.alphaMap.value=h.alphaMap,t(h.alphaMap,f.alphaMapTransform)),h.alphaTest>0&&(f.alphaTest.value=h.alphaTest)}function u(f,h){f.specular.value.copy(h.specular),f.shininess.value=Math.max(h.shininess,1e-4)}function p(f,h){h.gradientMap&&(f.gradientMap.value=h.gradientMap)}function d(f,h){f.metalness.value=h.metalness,h.metalnessMap&&(f.metalnessMap.value=h.metalnessMap,t(h.metalnessMap,f.metalnessMapTransform)),f.roughness.value=h.roughness,h.roughnessMap&&(f.roughnessMap.value=h.roughnessMap,t(h.roughnessMap,f.roughnessMapTransform)),h.envMap&&(f.envMapIntensity.value=h.envMapIntensity)}function m(f,h,b){f.ior.value=h.ior,h.sheen>0&&(f.sheenColor.value.copy(h.sheenColor).multiplyScalar(h.sheen),f.sheenRoughness.value=h.sheenRoughness,h.sheenColorMap&&(f.sheenColorMap.value=h.sheenColorMap,t(h.sheenColorMap,f.sheenColorMapTransform)),h.sheenRoughnessMap&&(f.sheenRoughnessMap.value=h.sheenRoughnessMap,t(h.sheenRoughnessMap,f.sheenRoughnessMapTransform))),h.clearcoat>0&&(f.clearcoat.value=h.clearcoat,f.clearcoatRoughness.value=h.clearcoatRoughness,h.clearcoatMap&&(f.clearcoatMap.value=h.clearcoatMap,t(h.clearcoatMap,f.clearcoatMapTransform)),h.clearcoatRoughnessMap&&(f.clearcoatRoughnessMap.value=h.clearcoatRoughnessMap,t(h.clearcoatRoughnessMap,f.clearcoatRoughnessMapTransform)),h.clearcoatNormalMap&&(f.clearcoatNormalMap.value=h.clearcoatNormalMap,t(h.clearcoatNormalMap,f.clearcoatNormalMapTransform),f.clearcoatNormalScale.value.copy(h.clearcoatNormalScale),h.side===Tt&&f.clearcoatNormalScale.value.negate())),h.dispersion>0&&(f.dispersion.value=h.dispersion),h.iridescence>0&&(f.iridescence.value=h.iridescence,f.iridescenceIOR.value=h.iridescenceIOR,f.iridescenceThicknessMinimum.value=h.iridescenceThicknessRange[0],f.iridescenceThicknessMaximum.value=h.iridescenceThicknessRange[1],h.iridescenceMap&&(f.iridescenceMap.value=h.iridescenceMap,t(h.iridescenceMap,f.iridescenceMapTransform)),h.iridescenceThicknessMap&&(f.iridescenceThicknessMap.value=h.iridescenceThicknessMap,t(h.iridescenceThicknessMap,f.iridescenceThicknessMapTransform))),h.transmission>0&&(f.transmission.value=h.transmission,f.transmissionSamplerMap.value=b.texture,f.transmissionSamplerSize.value.set(b.width,b.height),h.transmissionMap&&(f.transmissionMap.value=h.transmissionMap,t(h.transmissionMap,f.transmissionMapTransform)),f.thickness.value=h.thickness,h.thicknessMap&&(f.thicknessMap.value=h.thicknessMap,t(h.thicknessMap,f.thicknessMapTransform)),f.attenuationDistance.value=h.attenuationDistance,f.attenuationColor.value.copy(h.attenuationColor)),h.anisotropy>0&&(f.anisotropyVector.value.set(h.anisotropy*Math.cos(h.anisotropyRotation),h.anisotropy*Math.sin(h.anisotropyRotation)),h.anisotropyMap&&(f.anisotropyMap.value=h.anisotropyMap,t(h.anisotropyMap,f.anisotropyMapTransform))),f.specularIntensity.value=h.specularIntensity,f.specularColor.value.copy(h.specularColor),h.specularColorMap&&(f.specularColorMap.value=h.specularColorMap,t(h.specularColorMap,f.specularColorMapTransform)),h.specularIntensityMap&&(f.specularIntensityMap.value=h.specularIntensityMap,t(h.specularIntensityMap,f.specularIntensityMapTransform))}function v(f,h){h.matcap&&(f.matcap.value=h.matcap)}function M(f,h){const b=e.get(h).light;f.referencePosition.value.setFromMatrixPosition(b.matrixWorld),f.nearDistance.value=b.shadow.camera.near,f.farDistance.value=b.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:n}}function Mf(r,e,t,i){let n={},a={},s=[];const o=r.getParameter(r.MAX_UNIFORM_BUFFER_BINDINGS);function l(b,E){const T=E.program;i.uniformBlockBinding(b,T)}function c(b,E){let T=n[b.id];T===void 0&&(v(b),T=u(b),n[b.id]=T,b.addEventListener("dispose",f));const I=E.program;i.updateUBOMapping(b,I);const R=e.render.frame;a[b.id]!==R&&(d(b),a[b.id]=R)}function u(b){const E=p();b.__bindingPointIndex=E;const T=r.createBuffer(),I=b.__size,R=b.usage;return r.bindBuffer(r.UNIFORM_BUFFER,T),r.bufferData(r.UNIFORM_BUFFER,I,R),r.bindBuffer(r.UNIFORM_BUFFER,null),r.bindBufferBase(r.UNIFORM_BUFFER,E,T),T}function p(){for(let b=0;b<o;b++)if(s.indexOf(b)===-1)return s.push(b),b;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(b){const E=n[b.id],T=b.uniforms,I=b.__cache;r.bindBuffer(r.UNIFORM_BUFFER,E);for(let R=0,A=T.length;R<A;R++){const N=Array.isArray(T[R])?T[R]:[T[R]];for(let y=0,x=N.length;y<x;y++){const P=N[y];if(m(P,R,y,I)===!0){const k=P.__offset,H=Array.isArray(P.value)?P.value:[P.value];let W=0;for(let J=0;J<H.length;J++){const V=H[J],$=M(V);typeof V=="number"||typeof V=="boolean"?(P.__data[0]=V,r.bufferSubData(r.UNIFORM_BUFFER,k+W,P.__data)):V.isMatrix3?(P.__data[0]=V.elements[0],P.__data[1]=V.elements[1],P.__data[2]=V.elements[2],P.__data[3]=0,P.__data[4]=V.elements[3],P.__data[5]=V.elements[4],P.__data[6]=V.elements[5],P.__data[7]=0,P.__data[8]=V.elements[6],P.__data[9]=V.elements[7],P.__data[10]=V.elements[8],P.__data[11]=0):(V.toArray(P.__data,W),W+=$.storage/Float32Array.BYTES_PER_ELEMENT)}r.bufferSubData(r.UNIFORM_BUFFER,k,P.__data)}}}r.bindBuffer(r.UNIFORM_BUFFER,null)}function m(b,E,T,I){const R=b.value,A=E+"_"+T;if(I[A]===void 0)return typeof R=="number"||typeof R=="boolean"?I[A]=R:I[A]=R.clone(),!0;{const N=I[A];if(typeof R=="number"||typeof R=="boolean"){if(N!==R)return I[A]=R,!0}else if(N.equals(R)===!1)return N.copy(R),!0}return!1}function v(b){const E=b.uniforms;let T=0;const I=16;for(let A=0,N=E.length;A<N;A++){const y=Array.isArray(E[A])?E[A]:[E[A]];for(let x=0,P=y.length;x<P;x++){const k=y[x],H=Array.isArray(k.value)?k.value:[k.value];for(let W=0,J=H.length;W<J;W++){const V=H[W],$=M(V),G=T%I,te=G%$.boundary,pe=G+te;T+=te,pe!==0&&I-pe<$.storage&&(T+=I-pe),k.__data=new Float32Array($.storage/Float32Array.BYTES_PER_ELEMENT),k.__offset=T,T+=$.storage}}}const R=T%I;return R>0&&(T+=I-R),b.__size=T,b.__cache={},this}function M(b){const E={boundary:0,storage:0};return typeof b=="number"||typeof b=="boolean"?(E.boundary=4,E.storage=4):b.isVector2?(E.boundary=8,E.storage=8):b.isVector3||b.isColor?(E.boundary=16,E.storage=12):b.isVector4?(E.boundary=16,E.storage=16):b.isMatrix3?(E.boundary=48,E.storage=48):b.isMatrix4?(E.boundary=64,E.storage=64):b.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",b),E}function f(b){const E=b.target;E.removeEventListener("dispose",f);const T=s.indexOf(E.__bindingPointIndex);s.splice(T,1),r.deleteBuffer(n[E.id]),delete n[E.id],delete a[E.id]}function h(){for(const b in n)r.deleteBuffer(n[b]);s=[],n={},a={}}return{bind:l,update:c,dispose:h}}class yf{constructor(e={}){const{canvas:t=Kl(),context:i=null,depth:n=!0,stencil:a=!1,alpha:s=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:p=!1,reverseDepthBuffer:d=!1}=e;this.isWebGLRenderer=!0;let m;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");m=i.getContextAttributes().alpha}else m=s;const v=new Uint32Array(4),M=new Int32Array(4);let f=null,h=null;const b=[],E=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=It,this.toneMapping=xi,this.toneMappingExposure=1;const T=this;let I=!1,R=0,A=0,N=null,y=-1,x=null;const P=new Ze,k=new Ze;let H=null;const W=new Ue(0);let J=0,V=t.width,$=t.height,G=1,te=null,pe=null;const we=new Ze(0,0,V,$),De=new Ze(0,0,V,$);let Ke=!1;const X=new rs;let ee=!1,me=!1;this.transmissionResolutionScale=1;const ae=new tt,ye=new tt,Ae=new D,Ie=new Ze,it={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let He=!1;function at(){return N===null?G:1}let w=i;function Ct(_,U){return t.getContext(_,U)}try{const _={alpha:!0,depth:n,stencil:a,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:p};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${qa}`),t.addEventListener("webglcontextlost",q,!1),t.addEventListener("webglcontextrestored",oe,!1),t.addEventListener("webglcontextcreationerror",ie,!1),w===null){const U="webgl2";if(w=Ct(U,_),w===null)throw Ct(U)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(_){throw console.error("THREE.WebGLRenderer: "+_.message),_}let Oe,Fe,ve,Qe,_e,S,g,O,Y,K,j,ge,se,de,Ge,Q,he,Me,Se,ue,ze,Pe,Je,C;function ne(){Oe=new Pd(w),Oe.init(),Pe=new pf(w,Oe),Fe=new Ed(w,Oe,e,Pe),ve=new uf(w,Oe),Fe.reverseDepthBuffer&&d&&ve.buffers.depth.setReversed(!0),Qe=new Dd(w),_e=new Jp,S=new df(w,Oe,ve,_e,Fe,Pe,Qe),g=new wd(T),O=new Cd(T),Y=new Hc(w),Je=new Sd(w,Y),K=new Ld(w,Y,Qe,Je),j=new Nd(w,K,Y,Qe),Se=new Id(w,Fe,S),Q=new bd(_e),ge=new Kp(T,g,O,Oe,Fe,Je,Q),se=new xf(T,_e),de=new Qp,Ge=new sf(Oe),Me=new yd(T,g,O,ve,j,m,l),he=new cf(T,j,Fe),C=new Mf(w,Qe,Fe,ve),ue=new Td(w,Oe,Qe),ze=new Ud(w,Oe,Qe),Qe.programs=ge.programs,T.capabilities=Fe,T.extensions=Oe,T.properties=_e,T.renderLists=de,T.shadowMap=he,T.state=ve,T.info=Qe}ne();const B=new _f(T,w);this.xr=B,this.getContext=function(){return w},this.getContextAttributes=function(){return w.getContextAttributes()},this.forceContextLoss=function(){const _=Oe.get("WEBGL_lose_context");_&&_.loseContext()},this.forceContextRestore=function(){const _=Oe.get("WEBGL_lose_context");_&&_.restoreContext()},this.getPixelRatio=function(){return G},this.setPixelRatio=function(_){_!==void 0&&(G=_,this.setSize(V,$,!1))},this.getSize=function(_){return _.set(V,$)},this.setSize=function(_,U,F=!0){if(B.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}V=_,$=U,t.width=Math.floor(_*G),t.height=Math.floor(U*G),F===!0&&(t.style.width=_+"px",t.style.height=U+"px"),this.setViewport(0,0,_,U)},this.getDrawingBufferSize=function(_){return _.set(V*G,$*G).floor()},this.setDrawingBufferSize=function(_,U,F){V=_,$=U,G=F,t.width=Math.floor(_*F),t.height=Math.floor(U*F),this.setViewport(0,0,_,U)},this.getCurrentViewport=function(_){return _.copy(P)},this.getViewport=function(_){return _.copy(we)},this.setViewport=function(_,U,F,z){_.isVector4?we.set(_.x,_.y,_.z,_.w):we.set(_,U,F,z),ve.viewport(P.copy(we).multiplyScalar(G).round())},this.getScissor=function(_){return _.copy(De)},this.setScissor=function(_,U,F,z){_.isVector4?De.set(_.x,_.y,_.z,_.w):De.set(_,U,F,z),ve.scissor(k.copy(De).multiplyScalar(G).round())},this.getScissorTest=function(){return Ke},this.setScissorTest=function(_){ve.setScissorTest(Ke=_)},this.setOpaqueSort=function(_){te=_},this.setTransparentSort=function(_){pe=_},this.getClearColor=function(_){return _.copy(Me.getClearColor())},this.setClearColor=function(){Me.setClearColor.apply(Me,arguments)},this.getClearAlpha=function(){return Me.getClearAlpha()},this.setClearAlpha=function(){Me.setClearAlpha.apply(Me,arguments)},this.clear=function(_=!0,U=!0,F=!0){let z=0;if(_){let L=!1;if(N!==null){const Z=N.texture.format;L=Z===es||Z===Qa||Z===$a}if(L){const Z=N.texture.type,le=Z===ci||Z===Oi||Z===Cr||Z===ur||Z===Ka||Z===Ja,ce=Me.getClearColor(),fe=Me.getClearAlpha(),Ee=ce.r,Te=ce.g,be=ce.b;le?(v[0]=Ee,v[1]=Te,v[2]=be,v[3]=fe,w.clearBufferuiv(w.COLOR,0,v)):(M[0]=Ee,M[1]=Te,M[2]=be,M[3]=fe,w.clearBufferiv(w.COLOR,0,M))}else z|=w.COLOR_BUFFER_BIT}U&&(z|=w.DEPTH_BUFFER_BIT),F&&(z|=w.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),w.clear(z)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",q,!1),t.removeEventListener("webglcontextrestored",oe,!1),t.removeEventListener("webglcontextcreationerror",ie,!1),Me.dispose(),de.dispose(),Ge.dispose(),_e.dispose(),g.dispose(),O.dispose(),j.dispose(),Je.dispose(),C.dispose(),ge.dispose(),B.dispose(),B.removeEventListener("sessionstart",os),B.removeEventListener("sessionend",ls),Si.stop()};function q(_){_.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),I=!0}function oe(){console.log("THREE.WebGLRenderer: Context Restored."),I=!1;const _=Qe.autoReset,U=he.enabled,F=he.autoUpdate,z=he.needsUpdate,L=he.type;ne(),Qe.autoReset=_,he.enabled=U,he.autoUpdate=F,he.needsUpdate=z,he.type=L}function ie(_){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",_.statusMessage)}function Be(_){const U=_.target;U.removeEventListener("dispose",Be),rt(U)}function rt(_){ft(_),_e.remove(_)}function ft(_){const U=_e.get(_).programs;U!==void 0&&(U.forEach(function(F){ge.releaseProgram(F)}),_.isShaderMaterial&&ge.releaseShaderCache(_))}this.renderBufferDirect=function(_,U,F,z,L,Z){U===null&&(U=it);const le=L.isMesh&&L.matrixWorld.determinant()<0,ce=il(_,U,F,z,L);ve.setMaterial(z,le);let fe=F.index,Ee=1;if(z.wireframe===!0){if(fe=K.getWireframeAttribute(F),fe===void 0)return;Ee=2}const Te=F.drawRange,be=F.attributes.position;let ke=Te.start*Ee,Xe=(Te.start+Te.count)*Ee;Z!==null&&(ke=Math.max(ke,Z.start*Ee),Xe=Math.min(Xe,(Z.start+Z.count)*Ee)),fe!==null?(ke=Math.max(ke,0),Xe=Math.min(Xe,fe.count)):be!=null&&(ke=Math.max(ke,0),Xe=Math.min(Xe,be.count));const lt=Xe-ke;if(lt<0||lt===1/0)return;Je.setup(L,z,ce,F,fe);let je,$e=ue;if(fe!==null&&(je=Y.get(fe),$e=ze,$e.setIndex(je)),L.isMesh)z.wireframe===!0?(ve.setLineWidth(z.wireframeLinewidth*at()),$e.setMode(w.LINES)):$e.setMode(w.TRIANGLES);else if(L.isLine){let xe=z.linewidth;xe===void 0&&(xe=1),ve.setLineWidth(xe*at()),L.isLineSegments?$e.setMode(w.LINES):L.isLineLoop?$e.setMode(w.LINE_LOOP):$e.setMode(w.LINE_STRIP)}else L.isPoints?$e.setMode(w.POINTS):L.isSprite&&$e.setMode(w.TRIANGLES);if(L.isBatchedMesh)if(L._multiDrawInstances!==null)$e.renderMultiDrawInstances(L._multiDrawStarts,L._multiDrawCounts,L._multiDrawCount,L._multiDrawInstances);else if(Oe.get("WEBGL_multi_draw"))$e.renderMultiDraw(L._multiDrawStarts,L._multiDrawCounts,L._multiDrawCount);else{const xe=L._multiDrawStarts,vt=L._multiDrawCounts,Ti=L._multiDrawCount,Ot=fe?Y.get(fe).bytesPerElement:1,Hi=_e.get(z).currentProgram.getUniforms();for(let bt=0;bt<Ti;bt++)Hi.setValue(w,"_gl_DrawID",bt),$e.render(xe[bt]/Ot,vt[bt])}else if(L.isInstancedMesh)$e.renderInstances(ke,lt,L.count);else if(F.isInstancedBufferGeometry){const xe=F._maxInstanceCount!==void 0?F._maxInstanceCount:1/0,vt=Math.min(F.instanceCount,xe);$e.renderInstances(ke,lt,vt)}else $e.render(ke,lt)};function We(_,U,F){_.transparent===!0&&_.side===si&&_.forceSinglePass===!1?(_.side=Tt,_.needsUpdate=!0,Or(_,U,F),_.side=Mi,_.needsUpdate=!0,Or(_,U,F),_.side=si):Or(_,U,F)}this.compile=function(_,U,F=null){F===null&&(F=_),h=Ge.get(F),h.init(U),E.push(h),F.traverseVisible(function(L){L.isLight&&L.layers.test(U.layers)&&(h.pushLight(L),L.castShadow&&h.pushShadow(L))}),_!==F&&_.traverseVisible(function(L){L.isLight&&L.layers.test(U.layers)&&(h.pushLight(L),L.castShadow&&h.pushShadow(L))}),h.setupLights();const z=new Set;return _.traverse(function(L){if(!(L.isMesh||L.isPoints||L.isLine||L.isSprite))return;const Z=L.material;if(Z)if(Array.isArray(Z))for(let le=0;le<Z.length;le++){const ce=Z[le];We(ce,F,L),z.add(ce)}else We(Z,F,L),z.add(Z)}),E.pop(),h=null,z},this.compileAsync=function(_,U,F=null){const z=this.compile(_,U,F);return new Promise(L=>{function Z(){if(z.forEach(function(le){_e.get(le).currentProgram.isReady()&&z.delete(le)}),z.size===0){L(_);return}setTimeout(Z,10)}Oe.get("KHR_parallel_shader_compile")!==null?Z():setTimeout(Z,10)})};let Nt=null;function Qt(_){Nt&&Nt(_)}function os(){Si.stop()}function ls(){Si.start()}const Si=new Zo;Si.setAnimationLoop(Qt),typeof self<"u"&&Si.setContext(self),this.setAnimationLoop=function(_){Nt=_,B.setAnimationLoop(_),_===null?Si.stop():Si.start()},B.addEventListener("sessionstart",os),B.addEventListener("sessionend",ls),this.render=function(_,U){if(U!==void 0&&U.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(I===!0)return;if(_.matrixWorldAutoUpdate===!0&&_.updateMatrixWorld(),U.parent===null&&U.matrixWorldAutoUpdate===!0&&U.updateMatrixWorld(),B.enabled===!0&&B.isPresenting===!0&&(B.cameraAutoUpdate===!0&&B.updateCamera(U),U=B.getCamera()),_.isScene===!0&&_.onBeforeRender(T,_,U,N),h=Ge.get(_,E.length),h.init(U),E.push(h),ye.multiplyMatrices(U.projectionMatrix,U.matrixWorldInverse),X.setFromProjectionMatrix(ye),me=this.localClippingEnabled,ee=Q.init(this.clippingPlanes,me),f=de.get(_,b.length),f.init(),b.push(f),B.enabled===!0&&B.isPresenting===!0){const Z=T.xr.getDepthSensingMesh();Z!==null&&bn(Z,U,-1/0,T.sortObjects)}bn(_,U,0,T.sortObjects),f.finish(),T.sortObjects===!0&&f.sort(te,pe),He=B.enabled===!1||B.isPresenting===!1||B.hasDepthSensing()===!1,He&&Me.addToRenderList(f,_),this.info.render.frame++,ee===!0&&Q.beginShadows();const F=h.state.shadowsArray;he.render(F,_,U),ee===!0&&Q.endShadows(),this.info.autoReset===!0&&this.info.reset();const z=f.opaque,L=f.transmissive;if(h.setupLights(),U.isArrayCamera){const Z=U.cameras;if(L.length>0)for(let le=0,ce=Z.length;le<ce;le++){const fe=Z[le];hs(z,L,_,fe)}He&&Me.render(_);for(let le=0,ce=Z.length;le<ce;le++){const fe=Z[le];cs(f,_,fe,fe.viewport)}}else L.length>0&&hs(z,L,_,U),He&&Me.render(_),cs(f,_,U);N!==null&&A===0&&(S.updateMultisampleRenderTarget(N),S.updateRenderTargetMipmap(N)),_.isScene===!0&&_.onAfterRender(T,_,U),Je.resetDefaultState(),y=-1,x=null,E.pop(),E.length>0?(h=E[E.length-1],ee===!0&&Q.setGlobalState(T.clippingPlanes,h.state.camera)):h=null,b.pop(),b.length>0?f=b[b.length-1]:f=null};function bn(_,U,F,z){if(_.visible===!1)return;if(_.layers.test(U.layers)){if(_.isGroup)F=_.renderOrder;else if(_.isLOD)_.autoUpdate===!0&&_.update(U);else if(_.isLight)h.pushLight(_),_.castShadow&&h.pushShadow(_);else if(_.isSprite){if(!_.frustumCulled||X.intersectsSprite(_)){z&&Ie.setFromMatrixPosition(_.matrixWorld).applyMatrix4(ye);const Z=j.update(_),le=_.material;le.visible&&f.push(_,Z,le,F,Ie.z,null)}}else if((_.isMesh||_.isLine||_.isPoints)&&(!_.frustumCulled||X.intersectsObject(_))){const Z=j.update(_),le=_.material;if(z&&(_.boundingSphere!==void 0?(_.boundingSphere===null&&_.computeBoundingSphere(),Ie.copy(_.boundingSphere.center)):(Z.boundingSphere===null&&Z.computeBoundingSphere(),Ie.copy(Z.boundingSphere.center)),Ie.applyMatrix4(_.matrixWorld).applyMatrix4(ye)),Array.isArray(le)){const ce=Z.groups;for(let fe=0,Ee=ce.length;fe<Ee;fe++){const Te=ce[fe],be=le[Te.materialIndex];be&&be.visible&&f.push(_,Z,be,F,Ie.z,Te)}}else le.visible&&f.push(_,Z,le,F,Ie.z,null)}}const L=_.children;for(let Z=0,le=L.length;Z<le;Z++)bn(L[Z],U,F,z)}function cs(_,U,F,z){const L=_.opaque,Z=_.transmissive,le=_.transparent;h.setupLightsView(F),ee===!0&&Q.setGlobalState(T.clippingPlanes,F),z&&ve.viewport(P.copy(z)),L.length>0&&Nr(L,U,F),Z.length>0&&Nr(Z,U,F),le.length>0&&Nr(le,U,F),ve.buffers.depth.setTest(!0),ve.buffers.depth.setMask(!0),ve.buffers.color.setMask(!0),ve.setPolygonOffset(!1)}function hs(_,U,F,z){if((F.isScene===!0?F.overrideMaterial:null)!==null)return;h.state.transmissionRenderTarget[z.id]===void 0&&(h.state.transmissionRenderTarget[z.id]=new Fi(1,1,{generateMipmaps:!0,type:Oe.has("EXT_color_buffer_half_float")||Oe.has("EXT_color_buffer_float")?Lr:ci,minFilter:Ni,samples:4,stencilBuffer:a,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Ve.workingColorSpace}));const L=h.state.transmissionRenderTarget[z.id],Z=z.viewport||P;L.setSize(Z.z*T.transmissionResolutionScale,Z.w*T.transmissionResolutionScale);const le=T.getRenderTarget();T.setRenderTarget(L),T.getClearColor(W),J=T.getClearAlpha(),J<1&&T.setClearColor(16777215,.5),T.clear(),He&&Me.render(F);const ce=T.toneMapping;T.toneMapping=xi;const fe=z.viewport;if(z.viewport!==void 0&&(z.viewport=void 0),h.setupLightsView(z),ee===!0&&Q.setGlobalState(T.clippingPlanes,z),Nr(_,F,z),S.updateMultisampleRenderTarget(L),S.updateRenderTargetMipmap(L),Oe.has("WEBGL_multisampled_render_to_texture")===!1){let Ee=!1;for(let Te=0,be=U.length;Te<be;Te++){const ke=U[Te],Xe=ke.object,lt=ke.geometry,je=ke.material,$e=ke.group;if(je.side===si&&Xe.layers.test(z.layers)){const xe=je.side;je.side=Tt,je.needsUpdate=!0,us(Xe,F,z,lt,je,$e),je.side=xe,je.needsUpdate=!0,Ee=!0}}Ee===!0&&(S.updateMultisampleRenderTarget(L),S.updateRenderTargetMipmap(L))}T.setRenderTarget(le),T.setClearColor(W,J),fe!==void 0&&(z.viewport=fe),T.toneMapping=ce}function Nr(_,U,F){const z=U.isScene===!0?U.overrideMaterial:null;for(let L=0,Z=_.length;L<Z;L++){const le=_[L],ce=le.object,fe=le.geometry,Ee=z===null?le.material:z,Te=le.group;ce.layers.test(F.layers)&&us(ce,U,F,fe,Ee,Te)}}function us(_,U,F,z,L,Z){_.onBeforeRender(T,U,F,z,L,Z),_.modelViewMatrix.multiplyMatrices(F.matrixWorldInverse,_.matrixWorld),_.normalMatrix.getNormalMatrix(_.modelViewMatrix),L.onBeforeRender(T,U,F,z,_,Z),L.transparent===!0&&L.side===si&&L.forceSinglePass===!1?(L.side=Tt,L.needsUpdate=!0,T.renderBufferDirect(F,U,z,L,_,Z),L.side=Mi,L.needsUpdate=!0,T.renderBufferDirect(F,U,z,L,_,Z),L.side=si):T.renderBufferDirect(F,U,z,L,_,Z),_.onAfterRender(T,U,F,z,L,Z)}function Or(_,U,F){U.isScene!==!0&&(U=it);const z=_e.get(_),L=h.state.lights,Z=h.state.shadowsArray,le=L.state.version,ce=ge.getParameters(_,L.state,Z,U,F),fe=ge.getProgramCacheKey(ce);let Ee=z.programs;z.environment=_.isMeshStandardMaterial?U.environment:null,z.fog=U.fog,z.envMap=(_.isMeshStandardMaterial?O:g).get(_.envMap||z.environment),z.envMapRotation=z.environment!==null&&_.envMap===null?U.environmentRotation:_.envMapRotation,Ee===void 0&&(_.addEventListener("dispose",Be),Ee=new Map,z.programs=Ee);let Te=Ee.get(fe);if(Te!==void 0){if(z.currentProgram===Te&&z.lightsStateVersion===le)return ps(_,ce),Te}else ce.uniforms=ge.getUniforms(_),_.onBeforeCompile(ce,T),Te=ge.acquireProgram(ce,fe),Ee.set(fe,Te),z.uniforms=ce.uniforms;const be=z.uniforms;return(!_.isShaderMaterial&&!_.isRawShaderMaterial||_.clipping===!0)&&(be.clippingPlanes=Q.uniform),ps(_,ce),z.needsLights=nl(_),z.lightsStateVersion=le,z.needsLights&&(be.ambientLightColor.value=L.state.ambient,be.lightProbe.value=L.state.probe,be.directionalLights.value=L.state.directional,be.directionalLightShadows.value=L.state.directionalShadow,be.spotLights.value=L.state.spot,be.spotLightShadows.value=L.state.spotShadow,be.rectAreaLights.value=L.state.rectArea,be.ltc_1.value=L.state.rectAreaLTC1,be.ltc_2.value=L.state.rectAreaLTC2,be.pointLights.value=L.state.point,be.pointLightShadows.value=L.state.pointShadow,be.hemisphereLights.value=L.state.hemi,be.directionalShadowMap.value=L.state.directionalShadowMap,be.directionalShadowMatrix.value=L.state.directionalShadowMatrix,be.spotShadowMap.value=L.state.spotShadowMap,be.spotLightMatrix.value=L.state.spotLightMatrix,be.spotLightMap.value=L.state.spotLightMap,be.pointShadowMap.value=L.state.pointShadowMap,be.pointShadowMatrix.value=L.state.pointShadowMatrix),z.currentProgram=Te,z.uniformsList=null,Te}function ds(_){if(_.uniformsList===null){const U=_.currentProgram.getUniforms();_.uniformsList=mn.seqWithValue(U.seq,_.uniforms)}return _.uniformsList}function ps(_,U){const F=_e.get(_);F.outputColorSpace=U.outputColorSpace,F.batching=U.batching,F.batchingColor=U.batchingColor,F.instancing=U.instancing,F.instancingColor=U.instancingColor,F.instancingMorph=U.instancingMorph,F.skinning=U.skinning,F.morphTargets=U.morphTargets,F.morphNormals=U.morphNormals,F.morphColors=U.morphColors,F.morphTargetsCount=U.morphTargetsCount,F.numClippingPlanes=U.numClippingPlanes,F.numIntersection=U.numClipIntersection,F.vertexAlphas=U.vertexAlphas,F.vertexTangents=U.vertexTangents,F.toneMapping=U.toneMapping}function il(_,U,F,z,L){U.isScene!==!0&&(U=it),S.resetTextureUnits();const Z=U.fog,le=z.isMeshStandardMaterial?U.environment:null,ce=N===null?T.outputColorSpace:N.isXRRenderTarget===!0?N.texture.colorSpace:pr,fe=(z.isMeshStandardMaterial?O:g).get(z.envMap||le),Ee=z.vertexColors===!0&&!!F.attributes.color&&F.attributes.color.itemSize===4,Te=!!F.attributes.tangent&&(!!z.normalMap||z.anisotropy>0),be=!!F.morphAttributes.position,ke=!!F.morphAttributes.normal,Xe=!!F.morphAttributes.color;let lt=xi;z.toneMapped&&(N===null||N.isXRRenderTarget===!0)&&(lt=T.toneMapping);const je=F.morphAttributes.position||F.morphAttributes.normal||F.morphAttributes.color,$e=je!==void 0?je.length:0,xe=_e.get(z),vt=h.state.lights;if(ee===!0&&(me===!0||_!==x)){const pt=_===x&&z.id===y;Q.setState(z,_,pt)}let Ti=!1;z.version===xe.__version?(xe.needsLights&&xe.lightsStateVersion!==vt.state.version||xe.outputColorSpace!==ce||L.isBatchedMesh&&xe.batching===!1||!L.isBatchedMesh&&xe.batching===!0||L.isBatchedMesh&&xe.batchingColor===!0&&L.colorTexture===null||L.isBatchedMesh&&xe.batchingColor===!1&&L.colorTexture!==null||L.isInstancedMesh&&xe.instancing===!1||!L.isInstancedMesh&&xe.instancing===!0||L.isSkinnedMesh&&xe.skinning===!1||!L.isSkinnedMesh&&xe.skinning===!0||L.isInstancedMesh&&xe.instancingColor===!0&&L.instanceColor===null||L.isInstancedMesh&&xe.instancingColor===!1&&L.instanceColor!==null||L.isInstancedMesh&&xe.instancingMorph===!0&&L.morphTexture===null||L.isInstancedMesh&&xe.instancingMorph===!1&&L.morphTexture!==null||xe.envMap!==fe||z.fog===!0&&xe.fog!==Z||xe.numClippingPlanes!==void 0&&(xe.numClippingPlanes!==Q.numPlanes||xe.numIntersection!==Q.numIntersection)||xe.vertexAlphas!==Ee||xe.vertexTangents!==Te||xe.morphTargets!==be||xe.morphNormals!==ke||xe.morphColors!==Xe||xe.toneMapping!==lt||xe.morphTargetsCount!==$e)&&(Ti=!0):(Ti=!0,xe.__version=z.version);let Ot=xe.currentProgram;Ti===!0&&(Ot=Or(z,U,L));let Hi=!1,bt=!1,xr=!1;const et=Ot.getUniforms(),Pt=xe.uniforms;if(ve.useProgram(Ot.program)&&(Hi=!0,bt=!0,xr=!0),z.id!==y&&(y=z.id,bt=!0),Hi||x!==_){ve.buffers.depth.getReversed()?(ae.copy(_.projectionMatrix),$l(ae),Ql(ae),et.setValue(w,"projectionMatrix",ae)):et.setValue(w,"projectionMatrix",_.projectionMatrix),et.setValue(w,"viewMatrix",_.matrixWorldInverse);const pt=et.map.cameraPosition;pt!==void 0&&pt.setValue(w,Ae.setFromMatrixPosition(_.matrixWorld)),Fe.logarithmicDepthBuffer&&et.setValue(w,"logDepthBufFC",2/(Math.log(_.far+1)/Math.LN2)),(z.isMeshPhongMaterial||z.isMeshToonMaterial||z.isMeshLambertMaterial||z.isMeshBasicMaterial||z.isMeshStandardMaterial||z.isShaderMaterial)&&et.setValue(w,"isOrthographic",_.isOrthographicCamera===!0),x!==_&&(x=_,bt=!0,xr=!0)}if(L.isSkinnedMesh){et.setOptional(w,L,"bindMatrix"),et.setOptional(w,L,"bindMatrixInverse");const pt=L.skeleton;pt&&(pt.boneTexture===null&&pt.computeBoneTexture(),et.setValue(w,"boneTexture",pt.boneTexture,S))}L.isBatchedMesh&&(et.setOptional(w,L,"batchingTexture"),et.setValue(w,"batchingTexture",L._matricesTexture,S),et.setOptional(w,L,"batchingIdTexture"),et.setValue(w,"batchingIdTexture",L._indirectTexture,S),et.setOptional(w,L,"batchingColorTexture"),L._colorsTexture!==null&&et.setValue(w,"batchingColorTexture",L._colorsTexture,S));const Lt=F.morphAttributes;if((Lt.position!==void 0||Lt.normal!==void 0||Lt.color!==void 0)&&Se.update(L,F,Ot),(bt||xe.receiveShadow!==L.receiveShadow)&&(xe.receiveShadow=L.receiveShadow,et.setValue(w,"receiveShadow",L.receiveShadow)),z.isMeshGouraudMaterial&&z.envMap!==null&&(Pt.envMap.value=fe,Pt.flipEnvMap.value=fe.isCubeTexture&&fe.isRenderTargetTexture===!1?-1:1),z.isMeshStandardMaterial&&z.envMap===null&&U.environment!==null&&(Pt.envMapIntensity.value=U.environmentIntensity),bt&&(et.setValue(w,"toneMappingExposure",T.toneMappingExposure),xe.needsLights&&rl(Pt,xr),Z&&z.fog===!0&&se.refreshFogUniforms(Pt,Z),se.refreshMaterialUniforms(Pt,z,G,$,h.state.transmissionRenderTarget[_.id]),mn.upload(w,ds(xe),Pt,S)),z.isShaderMaterial&&z.uniformsNeedUpdate===!0&&(mn.upload(w,ds(xe),Pt,S),z.uniformsNeedUpdate=!1),z.isSpriteMaterial&&et.setValue(w,"center",L.center),et.setValue(w,"modelViewMatrix",L.modelViewMatrix),et.setValue(w,"normalMatrix",L.normalMatrix),et.setValue(w,"modelMatrix",L.matrixWorld),z.isShaderMaterial||z.isRawShaderMaterial){const pt=z.uniformsGroups;for(let Ft=0,wn=pt.length;Ft<wn;Ft++){const Ei=pt[Ft];C.update(Ei,Ot),C.bind(Ei,Ot)}}return Ot}function rl(_,U){_.ambientLightColor.needsUpdate=U,_.lightProbe.needsUpdate=U,_.directionalLights.needsUpdate=U,_.directionalLightShadows.needsUpdate=U,_.pointLights.needsUpdate=U,_.pointLightShadows.needsUpdate=U,_.spotLights.needsUpdate=U,_.spotLightShadows.needsUpdate=U,_.rectAreaLights.needsUpdate=U,_.hemisphereLights.needsUpdate=U}function nl(_){return _.isMeshLambertMaterial||_.isMeshToonMaterial||_.isMeshPhongMaterial||_.isMeshStandardMaterial||_.isShadowMaterial||_.isShaderMaterial&&_.lights===!0}this.getActiveCubeFace=function(){return R},this.getActiveMipmapLevel=function(){return A},this.getRenderTarget=function(){return N},this.setRenderTargetTextures=function(_,U,F){_e.get(_.texture).__webglTexture=U,_e.get(_.depthTexture).__webglTexture=F;const z=_e.get(_);z.__hasExternalTextures=!0,z.__autoAllocateDepthBuffer=F===void 0,z.__autoAllocateDepthBuffer||Oe.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),z.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(_,U){const F=_e.get(_);F.__webglFramebuffer=U,F.__useDefaultFramebuffer=U===void 0};const al=w.createFramebuffer();this.setRenderTarget=function(_,U=0,F=0){N=_,R=U,A=F;let z=!0,L=null,Z=!1,le=!1;if(_){const ce=_e.get(_);if(ce.__useDefaultFramebuffer!==void 0)ve.bindFramebuffer(w.FRAMEBUFFER,null),z=!1;else if(ce.__webglFramebuffer===void 0)S.setupRenderTarget(_);else if(ce.__hasExternalTextures)S.rebindTextures(_,_e.get(_.texture).__webglTexture,_e.get(_.depthTexture).__webglTexture);else if(_.depthBuffer){const Te=_.depthTexture;if(ce.__boundDepthTexture!==Te){if(Te!==null&&_e.has(Te)&&(_.width!==Te.image.width||_.height!==Te.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");S.setupDepthRenderbuffer(_)}}const fe=_.texture;(fe.isData3DTexture||fe.isDataArrayTexture||fe.isCompressedArrayTexture)&&(le=!0);const Ee=_e.get(_).__webglFramebuffer;_.isWebGLCubeRenderTarget?(Array.isArray(Ee[U])?L=Ee[U][F]:L=Ee[U],Z=!0):_.samples>0&&S.useMultisampledRTT(_)===!1?L=_e.get(_).__webglMultisampledFramebuffer:Array.isArray(Ee)?L=Ee[F]:L=Ee,P.copy(_.viewport),k.copy(_.scissor),H=_.scissorTest}else P.copy(we).multiplyScalar(G).floor(),k.copy(De).multiplyScalar(G).floor(),H=Ke;if(F!==0&&(L=al),ve.bindFramebuffer(w.FRAMEBUFFER,L)&&z&&ve.drawBuffers(_,L),ve.viewport(P),ve.scissor(k),ve.setScissorTest(H),Z){const ce=_e.get(_.texture);w.framebufferTexture2D(w.FRAMEBUFFER,w.COLOR_ATTACHMENT0,w.TEXTURE_CUBE_MAP_POSITIVE_X+U,ce.__webglTexture,F)}else if(le){const ce=_e.get(_.texture),fe=U;w.framebufferTextureLayer(w.FRAMEBUFFER,w.COLOR_ATTACHMENT0,ce.__webglTexture,F,fe)}else if(_!==null&&F!==0){const ce=_e.get(_.texture);w.framebufferTexture2D(w.FRAMEBUFFER,w.COLOR_ATTACHMENT0,w.TEXTURE_2D,ce.__webglTexture,F)}y=-1},this.readRenderTargetPixels=function(_,U,F,z,L,Z,le){if(!(_&&_.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let ce=_e.get(_).__webglFramebuffer;if(_.isWebGLCubeRenderTarget&&le!==void 0&&(ce=ce[le]),ce){ve.bindFramebuffer(w.FRAMEBUFFER,ce);try{const fe=_.texture,Ee=fe.format,Te=fe.type;if(!Fe.textureFormatReadable(Ee)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Fe.textureTypeReadable(Te)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}U>=0&&U<=_.width-z&&F>=0&&F<=_.height-L&&w.readPixels(U,F,z,L,Pe.convert(Ee),Pe.convert(Te),Z)}finally{const fe=N!==null?_e.get(N).__webglFramebuffer:null;ve.bindFramebuffer(w.FRAMEBUFFER,fe)}}},this.readRenderTargetPixelsAsync=async function(_,U,F,z,L,Z,le){if(!(_&&_.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let ce=_e.get(_).__webglFramebuffer;if(_.isWebGLCubeRenderTarget&&le!==void 0&&(ce=ce[le]),ce){const fe=_.texture,Ee=fe.format,Te=fe.type;if(!Fe.textureFormatReadable(Ee))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Fe.textureTypeReadable(Te))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(U>=0&&U<=_.width-z&&F>=0&&F<=_.height-L){ve.bindFramebuffer(w.FRAMEBUFFER,ce);const be=w.createBuffer();w.bindBuffer(w.PIXEL_PACK_BUFFER,be),w.bufferData(w.PIXEL_PACK_BUFFER,Z.byteLength,w.STREAM_READ),w.readPixels(U,F,z,L,Pe.convert(Ee),Pe.convert(Te),0);const ke=N!==null?_e.get(N).__webglFramebuffer:null;ve.bindFramebuffer(w.FRAMEBUFFER,ke);const Xe=w.fenceSync(w.SYNC_GPU_COMMANDS_COMPLETE,0);return w.flush(),await Jl(w,Xe,4),w.bindBuffer(w.PIXEL_PACK_BUFFER,be),w.getBufferSubData(w.PIXEL_PACK_BUFFER,0,Z),w.deleteBuffer(be),w.deleteSync(Xe),Z}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")}},this.copyFramebufferToTexture=function(_,U=null,F=0){_.isTexture!==!0&&(tr("WebGLRenderer: copyFramebufferToTexture function signature has changed."),U=arguments[0]||null,_=arguments[1]);const z=Math.pow(2,-F),L=Math.floor(_.image.width*z),Z=Math.floor(_.image.height*z),le=U!==null?U.x:0,ce=U!==null?U.y:0;S.setTexture2D(_,0),w.copyTexSubImage2D(w.TEXTURE_2D,F,0,0,le,ce,L,Z),ve.unbindTexture()};const sl=w.createFramebuffer(),ol=w.createFramebuffer();this.copyTextureToTexture=function(_,U,F=null,z=null,L=0,Z=null){_.isTexture!==!0&&(tr("WebGLRenderer: copyTextureToTexture function signature has changed."),z=arguments[0]||null,_=arguments[1],U=arguments[2],Z=arguments[3]||0,F=null),Z===null&&(L!==0?(tr("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),Z=L,L=0):Z=0);let le,ce,fe,Ee,Te,be,ke,Xe,lt;const je=_.isCompressedTexture?_.mipmaps[Z]:_.image;if(F!==null)le=F.max.x-F.min.x,ce=F.max.y-F.min.y,fe=F.isBox3?F.max.z-F.min.z:1,Ee=F.min.x,Te=F.min.y,be=F.isBox3?F.min.z:0;else{const Lt=Math.pow(2,-L);le=Math.floor(je.width*Lt),ce=Math.floor(je.height*Lt),_.isDataArrayTexture?fe=je.depth:_.isData3DTexture?fe=Math.floor(je.depth*Lt):fe=1,Ee=0,Te=0,be=0}z!==null?(ke=z.x,Xe=z.y,lt=z.z):(ke=0,Xe=0,lt=0);const $e=Pe.convert(U.format),xe=Pe.convert(U.type);let vt;U.isData3DTexture?(S.setTexture3D(U,0),vt=w.TEXTURE_3D):U.isDataArrayTexture||U.isCompressedArrayTexture?(S.setTexture2DArray(U,0),vt=w.TEXTURE_2D_ARRAY):(S.setTexture2D(U,0),vt=w.TEXTURE_2D),w.pixelStorei(w.UNPACK_FLIP_Y_WEBGL,U.flipY),w.pixelStorei(w.UNPACK_PREMULTIPLY_ALPHA_WEBGL,U.premultiplyAlpha),w.pixelStorei(w.UNPACK_ALIGNMENT,U.unpackAlignment);const Ti=w.getParameter(w.UNPACK_ROW_LENGTH),Ot=w.getParameter(w.UNPACK_IMAGE_HEIGHT),Hi=w.getParameter(w.UNPACK_SKIP_PIXELS),bt=w.getParameter(w.UNPACK_SKIP_ROWS),xr=w.getParameter(w.UNPACK_SKIP_IMAGES);w.pixelStorei(w.UNPACK_ROW_LENGTH,je.width),w.pixelStorei(w.UNPACK_IMAGE_HEIGHT,je.height),w.pixelStorei(w.UNPACK_SKIP_PIXELS,Ee),w.pixelStorei(w.UNPACK_SKIP_ROWS,Te),w.pixelStorei(w.UNPACK_SKIP_IMAGES,be);const et=_.isDataArrayTexture||_.isData3DTexture,Pt=U.isDataArrayTexture||U.isData3DTexture;if(_.isDepthTexture){const Lt=_e.get(_),pt=_e.get(U),Ft=_e.get(Lt.__renderTarget),wn=_e.get(pt.__renderTarget);ve.bindFramebuffer(w.READ_FRAMEBUFFER,Ft.__webglFramebuffer),ve.bindFramebuffer(w.DRAW_FRAMEBUFFER,wn.__webglFramebuffer);for(let Ei=0;Ei<fe;Ei++)et&&(w.framebufferTextureLayer(w.READ_FRAMEBUFFER,w.COLOR_ATTACHMENT0,_e.get(_).__webglTexture,L,be+Ei),w.framebufferTextureLayer(w.DRAW_FRAMEBUFFER,w.COLOR_ATTACHMENT0,_e.get(U).__webglTexture,Z,lt+Ei)),w.blitFramebuffer(Ee,Te,le,ce,ke,Xe,le,ce,w.DEPTH_BUFFER_BIT,w.NEAREST);ve.bindFramebuffer(w.READ_FRAMEBUFFER,null),ve.bindFramebuffer(w.DRAW_FRAMEBUFFER,null)}else if(L!==0||_.isRenderTargetTexture||_e.has(_)){const Lt=_e.get(_),pt=_e.get(U);ve.bindFramebuffer(w.READ_FRAMEBUFFER,sl),ve.bindFramebuffer(w.DRAW_FRAMEBUFFER,ol);for(let Ft=0;Ft<fe;Ft++)et?w.framebufferTextureLayer(w.READ_FRAMEBUFFER,w.COLOR_ATTACHMENT0,Lt.__webglTexture,L,be+Ft):w.framebufferTexture2D(w.READ_FRAMEBUFFER,w.COLOR_ATTACHMENT0,w.TEXTURE_2D,Lt.__webglTexture,L),Pt?w.framebufferTextureLayer(w.DRAW_FRAMEBUFFER,w.COLOR_ATTACHMENT0,pt.__webglTexture,Z,lt+Ft):w.framebufferTexture2D(w.DRAW_FRAMEBUFFER,w.COLOR_ATTACHMENT0,w.TEXTURE_2D,pt.__webglTexture,Z),L!==0?w.blitFramebuffer(Ee,Te,le,ce,ke,Xe,le,ce,w.COLOR_BUFFER_BIT,w.NEAREST):Pt?w.copyTexSubImage3D(vt,Z,ke,Xe,lt+Ft,Ee,Te,le,ce):w.copyTexSubImage2D(vt,Z,ke,Xe,Ee,Te,le,ce);ve.bindFramebuffer(w.READ_FRAMEBUFFER,null),ve.bindFramebuffer(w.DRAW_FRAMEBUFFER,null)}else Pt?_.isDataTexture||_.isData3DTexture?w.texSubImage3D(vt,Z,ke,Xe,lt,le,ce,fe,$e,xe,je.data):U.isCompressedArrayTexture?w.compressedTexSubImage3D(vt,Z,ke,Xe,lt,le,ce,fe,$e,je.data):w.texSubImage3D(vt,Z,ke,Xe,lt,le,ce,fe,$e,xe,je):_.isDataTexture?w.texSubImage2D(w.TEXTURE_2D,Z,ke,Xe,le,ce,$e,xe,je.data):_.isCompressedTexture?w.compressedTexSubImage2D(w.TEXTURE_2D,Z,ke,Xe,je.width,je.height,$e,je.data):w.texSubImage2D(w.TEXTURE_2D,Z,ke,Xe,le,ce,$e,xe,je);w.pixelStorei(w.UNPACK_ROW_LENGTH,Ti),w.pixelStorei(w.UNPACK_IMAGE_HEIGHT,Ot),w.pixelStorei(w.UNPACK_SKIP_PIXELS,Hi),w.pixelStorei(w.UNPACK_SKIP_ROWS,bt),w.pixelStorei(w.UNPACK_SKIP_IMAGES,xr),Z===0&&U.generateMipmaps&&w.generateMipmap(vt),ve.unbindTexture()},this.copyTextureToTexture3D=function(_,U,F=null,z=null,L=0){return _.isTexture!==!0&&(tr("WebGLRenderer: copyTextureToTexture3D function signature has changed."),F=arguments[0]||null,z=arguments[1]||null,_=arguments[2],U=arguments[3],L=arguments[4]||0),tr('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(_,U,F,z,L)},this.initRenderTarget=function(_){_e.get(_).__webglFramebuffer===void 0&&S.setupRenderTarget(_)},this.initTexture=function(_){_.isCubeTexture?S.setTextureCube(_,0):_.isData3DTexture?S.setTexture3D(_,0):_.isDataArrayTexture||_.isCompressedArrayTexture?S.setTexture2DArray(_,0):S.setTexture2D(_,0),ve.unbindTexture()},this.resetState=function(){R=0,A=0,N=null,ve.reset(),Je.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Kt}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorspace=Ve._getDrawingBufferColorSpace(e),t.unpackColorSpace=Ve._getUnpackColorSpace()}}const vo={type:"change"},ss={type:"start"},el={type:"end"},ln=new ts,xo=new gi,Sf=Math.cos(70*Zl.DEG2RAD),ct=new D,St=2*Math.PI,qe={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},aa=1e-6;class Tf extends zc{constructor(e,t=null){super(e,t),this.state=qe.NONE,this.enabled=!0,this.target=new D,this.cursor=new D,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:nr.ROTATE,MIDDLE:nr.DOLLY,RIGHT:nr.PAN},this.touches={ONE:ir.ROTATE,TWO:ir.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._domElementKeyEvents=null,this._lastPosition=new D,this._lastQuaternion=new zi,this._lastTargetPosition=new D,this._quat=new zi().setFromUnitVectors(e.up,new D(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new Xs,this._sphericalDelta=new Xs,this._scale=1,this._panOffset=new D,this._rotateStart=new Re,this._rotateEnd=new Re,this._rotateDelta=new Re,this._panStart=new Re,this._panEnd=new Re,this._panDelta=new Re,this._dollyStart=new Re,this._dollyEnd=new Re,this._dollyDelta=new Re,this._dollyDirection=new D,this._mouse=new Re,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=bf.bind(this),this._onPointerDown=Ef.bind(this),this._onPointerUp=wf.bind(this),this._onContextMenu=Df.bind(this),this._onMouseWheel=Cf.bind(this),this._onKeyDown=Pf.bind(this),this._onTouchStart=Lf.bind(this),this._onTouchMove=Uf.bind(this),this._onMouseDown=Af.bind(this),this._onMouseMove=Rf.bind(this),this._interceptControlDown=If.bind(this),this._interceptControlUp=Nf.bind(this),this.domElement!==null&&this.connect(),this.update()}connect(){this.domElement.addEventListener("pointerdown",this._onPointerDown),this.domElement.addEventListener("pointercancel",this._onPointerUp),this.domElement.addEventListener("contextmenu",this._onContextMenu),this.domElement.addEventListener("wheel",this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener("keydown",this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction="none"}disconnect(){this.domElement.removeEventListener("pointerdown",this._onPointerDown),this.domElement.removeEventListener("pointermove",this._onPointerMove),this.domElement.removeEventListener("pointerup",this._onPointerUp),this.domElement.removeEventListener("pointercancel",this._onPointerUp),this.domElement.removeEventListener("wheel",this._onMouseWheel),this.domElement.removeEventListener("contextmenu",this._onContextMenu),this.stopListenToKeyEvents(),this.domElement.getRootNode().removeEventListener("keydown",this._interceptControlDown,{capture:!0}),this.domElement.style.touchAction="auto"}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(e){e.addEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=e}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(vo),this.update(),this.state=qe.NONE}update(e=null){const t=this.object.position;ct.copy(t).sub(this.target),ct.applyQuaternion(this._quat),this._spherical.setFromVector3(ct),this.autoRotate&&this.state===qe.NONE&&this._rotateLeft(this._getAutoRotationAngle(e)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let i=this.minAzimuthAngle,n=this.maxAzimuthAngle;isFinite(i)&&isFinite(n)&&(i<-Math.PI?i+=St:i>Math.PI&&(i-=St),n<-Math.PI?n+=St:n>Math.PI&&(n-=St),i<=n?this._spherical.theta=Math.max(i,Math.min(n,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(i+n)/2?Math.max(i,this._spherical.theta):Math.min(n,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let a=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{const s=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),a=s!=this._spherical.radius}if(ct.setFromSpherical(this._spherical),ct.applyQuaternion(this._quatInverse),t.copy(this.target).add(ct),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let s=null;if(this.object.isPerspectiveCamera){const o=ct.length();s=this._clampDistance(o*this._scale);const l=o-s;this.object.position.addScaledVector(this._dollyDirection,l),this.object.updateMatrixWorld(),a=!!l}else if(this.object.isOrthographicCamera){const o=new D(this._mouse.x,this._mouse.y,0);o.unproject(this.object);const l=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),a=l!==this.object.zoom;const c=new D(this._mouse.x,this._mouse.y,0);c.unproject(this.object),this.object.position.sub(c).add(o),this.object.updateMatrixWorld(),s=ct.length()}else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."),this.zoomToCursor=!1;s!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(s).add(this.object.position):(ln.origin.copy(this.object.position),ln.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(ln.direction))<Sf?this.object.lookAt(this.target):(xo.setFromNormalAndCoplanarPoint(this.object.up,this.target),ln.intersectPlane(xo,this.target))))}else if(this.object.isOrthographicCamera){const s=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),s!==this.object.zoom&&(this.object.updateProjectionMatrix(),a=!0)}return this._scale=1,this._performCursorZoom=!1,a||this._lastPosition.distanceToSquared(this.object.position)>aa||8*(1-this._lastQuaternion.dot(this.object.quaternion))>aa||this._lastTargetPosition.distanceToSquared(this.target)>aa?(this.dispatchEvent(vo),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(e){return e!==null?St/60*this.autoRotateSpeed*e:St/60/60*this.autoRotateSpeed}_getZoomScale(e){const t=Math.abs(e*.01);return Math.pow(.95,this.zoomSpeed*t)}_rotateLeft(e){this._sphericalDelta.theta-=e}_rotateUp(e){this._sphericalDelta.phi-=e}_panLeft(e,t){ct.setFromMatrixColumn(t,0),ct.multiplyScalar(-e),this._panOffset.add(ct)}_panUp(e,t){this.screenSpacePanning===!0?ct.setFromMatrixColumn(t,1):(ct.setFromMatrixColumn(t,0),ct.crossVectors(this.object.up,ct)),ct.multiplyScalar(e),this._panOffset.add(ct)}_pan(e,t){const i=this.domElement;if(this.object.isPerspectiveCamera){const n=this.object.position;ct.copy(n).sub(this.target);let a=ct.length();a*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*e*a/i.clientHeight,this.object.matrix),this._panUp(2*t*a/i.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(e*(this.object.right-this.object.left)/this.object.zoom/i.clientWidth,this.object.matrix),this._panUp(t*(this.object.top-this.object.bottom)/this.object.zoom/i.clientHeight,this.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),this.enablePan=!1)}_dollyOut(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=e:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_dollyIn(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=e:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_updateZoomParameters(e,t){if(!this.zoomToCursor)return;this._performCursorZoom=!0;const i=this.domElement.getBoundingClientRect(),n=e-i.left,a=t-i.top,s=i.width,o=i.height;this._mouse.x=n/s*2-1,this._mouse.y=-(a/o)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(e){return Math.max(this.minDistance,Math.min(this.maxDistance,e))}_handleMouseDownRotate(e){this._rotateStart.set(e.clientX,e.clientY)}_handleMouseDownDolly(e){this._updateZoomParameters(e.clientX,e.clientX),this._dollyStart.set(e.clientX,e.clientY)}_handleMouseDownPan(e){this._panStart.set(e.clientX,e.clientY)}_handleMouseMoveRotate(e){this._rotateEnd.set(e.clientX,e.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const t=this.domElement;this._rotateLeft(St*this._rotateDelta.x/t.clientHeight),this._rotateUp(St*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(e){this._dollyEnd.set(e.clientX,e.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(e){this._panEnd.set(e.clientX,e.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(e){this._updateZoomParameters(e.clientX,e.clientY),e.deltaY<0?this._dollyIn(this._getZoomScale(e.deltaY)):e.deltaY>0&&this._dollyOut(this._getZoomScale(e.deltaY)),this.update()}_handleKeyDown(e){let t=!1;switch(e.code){case this.keys.UP:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(St*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),t=!0;break;case this.keys.BOTTOM:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(-St*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),t=!0;break;case this.keys.LEFT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(St*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),t=!0;break;case this.keys.RIGHT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(-St*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),t=!0;break}t&&(e.preventDefault(),this.update())}_handleTouchStartRotate(e){if(this._pointers.length===1)this._rotateStart.set(e.pageX,e.pageY);else{const t=this._getSecondPointerPosition(e),i=.5*(e.pageX+t.x),n=.5*(e.pageY+t.y);this._rotateStart.set(i,n)}}_handleTouchStartPan(e){if(this._pointers.length===1)this._panStart.set(e.pageX,e.pageY);else{const t=this._getSecondPointerPosition(e),i=.5*(e.pageX+t.x),n=.5*(e.pageY+t.y);this._panStart.set(i,n)}}_handleTouchStartDolly(e){const t=this._getSecondPointerPosition(e),i=e.pageX-t.x,n=e.pageY-t.y,a=Math.sqrt(i*i+n*n);this._dollyStart.set(0,a)}_handleTouchStartDollyPan(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enablePan&&this._handleTouchStartPan(e)}_handleTouchStartDollyRotate(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enableRotate&&this._handleTouchStartRotate(e)}_handleTouchMoveRotate(e){if(this._pointers.length==1)this._rotateEnd.set(e.pageX,e.pageY);else{const i=this._getSecondPointerPosition(e),n=.5*(e.pageX+i.x),a=.5*(e.pageY+i.y);this._rotateEnd.set(n,a)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const t=this.domElement;this._rotateLeft(St*this._rotateDelta.x/t.clientHeight),this._rotateUp(St*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(e){if(this._pointers.length===1)this._panEnd.set(e.pageX,e.pageY);else{const t=this._getSecondPointerPosition(e),i=.5*(e.pageX+t.x),n=.5*(e.pageY+t.y);this._panEnd.set(i,n)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(e){const t=this._getSecondPointerPosition(e),i=e.pageX-t.x,n=e.pageY-t.y,a=Math.sqrt(i*i+n*n);this._dollyEnd.set(0,a),this._dollyDelta.set(0,Math.pow(this._dollyEnd.y/this._dollyStart.y,this.zoomSpeed)),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);const s=(e.pageX+t.x)*.5,o=(e.pageY+t.y)*.5;this._updateZoomParameters(s,o)}_handleTouchMoveDollyPan(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enablePan&&this._handleTouchMovePan(e)}_handleTouchMoveDollyRotate(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enableRotate&&this._handleTouchMoveRotate(e)}_addPointer(e){this._pointers.push(e.pointerId)}_removePointer(e){delete this._pointerPositions[e.pointerId];for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId){this._pointers.splice(t,1);return}}_isTrackingPointer(e){for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId)return!0;return!1}_trackPointer(e){let t=this._pointerPositions[e.pointerId];t===void 0&&(t=new Re,this._pointerPositions[e.pointerId]=t),t.set(e.pageX,e.pageY)}_getSecondPointerPosition(e){const t=e.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[t]}_customWheelEvent(e){const t=e.deltaMode,i={clientX:e.clientX,clientY:e.clientY,deltaY:e.deltaY};switch(t){case 1:i.deltaY*=16;break;case 2:i.deltaY*=100;break}return e.ctrlKey&&!this._controlActive&&(i.deltaY*=10),i}}function Ef(r){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(r.pointerId),this.domElement.addEventListener("pointermove",this._onPointerMove),this.domElement.addEventListener("pointerup",this._onPointerUp)),!this._isTrackingPointer(r)&&(this._addPointer(r),r.pointerType==="touch"?this._onTouchStart(r):this._onMouseDown(r)))}function bf(r){this.enabled!==!1&&(r.pointerType==="touch"?this._onTouchMove(r):this._onMouseMove(r))}function wf(r){switch(this._removePointer(r),this._pointers.length){case 0:this.domElement.releasePointerCapture(r.pointerId),this.domElement.removeEventListener("pointermove",this._onPointerMove),this.domElement.removeEventListener("pointerup",this._onPointerUp),this.dispatchEvent(el),this.state=qe.NONE;break;case 1:const e=this._pointers[0],t=this._pointerPositions[e];this._onTouchStart({pointerId:e,pageX:t.x,pageY:t.y});break}}function Af(r){let e;switch(r.button){case 0:e=this.mouseButtons.LEFT;break;case 1:e=this.mouseButtons.MIDDLE;break;case 2:e=this.mouseButtons.RIGHT;break;default:e=-1}switch(e){case nr.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(r),this.state=qe.DOLLY;break;case nr.ROTATE:if(r.ctrlKey||r.metaKey||r.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(r),this.state=qe.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(r),this.state=qe.ROTATE}break;case nr.PAN:if(r.ctrlKey||r.metaKey||r.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(r),this.state=qe.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(r),this.state=qe.PAN}break;default:this.state=qe.NONE}this.state!==qe.NONE&&this.dispatchEvent(ss)}function Rf(r){switch(this.state){case qe.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(r);break;case qe.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(r);break;case qe.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(r);break}}function Cf(r){this.enabled===!1||this.enableZoom===!1||this.state!==qe.NONE||(r.preventDefault(),this.dispatchEvent(ss),this._handleMouseWheel(this._customWheelEvent(r)),this.dispatchEvent(el))}function Pf(r){this.enabled!==!1&&this._handleKeyDown(r)}function Lf(r){switch(this._trackPointer(r),this._pointers.length){case 1:switch(this.touches.ONE){case ir.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(r),this.state=qe.TOUCH_ROTATE;break;case ir.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(r),this.state=qe.TOUCH_PAN;break;default:this.state=qe.NONE}break;case 2:switch(this.touches.TWO){case ir.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(r),this.state=qe.TOUCH_DOLLY_PAN;break;case ir.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(r),this.state=qe.TOUCH_DOLLY_ROTATE;break;default:this.state=qe.NONE}break;default:this.state=qe.NONE}this.state!==qe.NONE&&this.dispatchEvent(ss)}function Uf(r){switch(this._trackPointer(r),this.state){case qe.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(r),this.update();break;case qe.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(r),this.update();break;case qe.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(r),this.update();break;case qe.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(r),this.update();break;default:this.state=qe.NONE}}function Df(r){this.enabled!==!1&&r.preventDefault()}function If(r){r.key==="Control"&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}function Nf(r){r.key==="Control"&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}new Dt(.8,32,32),new Dt(.3,32,32),new Dt(.5,32,32),new Dt(.6,32,32),new Dt(.8,32,32),new Dt(.9,32,32),new Dt(.4,32,32),new Dt(.5,32,32),new Dt(.6,32,32),new Dt(.7,32,32);new Gt({color:3355443}),new Gt({color:16777215}),new Gt({color:16711680}),new Gt({color:255}),new Gt({color:16776960}),new Gt({color:16711935}),new Gt({color:65280}),new Gt({color:65280}),new Gt({color:65280});const Of=document.createElement("canvas");document.body.appendChild(Of);const qt=new Ec,Pr=new Rt(75,window.innerWidth/window.innerHeight,.1,1e3);Pr.position.z=5;const sa={x:0,y:0,z:0},vr=new yf({antialias:!0});vr.setSize(window.innerWidth,window.innerHeight);vr.shadowMap.enabled=!0;vr.shadowMap.type=yo;document.body.appendChild(vr.domElement);const Ff=new Tf(Pr,vr.domElement);gn("Scene and renderer initialized.");function zf(r){for(gn(`Initializing scene with molecule CSID: ${r}`);qt.children.length>0;)qt.remove(qt.children[0]);gn("Scene cleared.");const e=new Fc(5);qt.add(e);const t=new gr(1,1,1),i=new Gt({color:65280}),n=new Wt(t,i);n.castShadow=!0,qt.add(n),Bf(),Pr.position.set(5,5,5),Pr.lookAt(0,0,0),gn("Camera positioned and oriented.")}function tl(){requestAnimationFrame(tl),vr.render(qt,Pr),Ff.update()}zf(2424);tl();new Ar;function Bf(){const r=new Uc(16777215,1,100);r.position.set(sa.x,sa.y,sa.z+10),r.castShadow=!0,r.shadow.mapSize.width=1024,r.shadow.mapSize.height=1024,r.shadow.camera.near=.1,r.shadow.camera.far=100,qt.add(r);const e=new Ir(500,500),t=new Gt({color:5592405}),i=new Wt(e,t);i.rotation.x=-Math.PI/2,i.position.y=-10,i.receiveShadow=!0,i.position.y=-1,qt.add(i);{const a=new Oc(r.shadow.camera);qt.add(a)}const n=new Ic(4210752);qt.add(n)}function gn(...r){console.log("[DEBUG]",...r)}
//# sourceMappingURL=index-CqpJINld.js.map
