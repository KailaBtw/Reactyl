  ...
  return (
    <div className={`border-t ${themeClasses.card}`}>
      <div className="flex flex-row gap-3">
        ...
        <div className="w-2/5 p-3 bg-gray-50 border border-gray-200 rounded-lg">
            ...
            <div className="space-y-1">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-sm font-mono font-bold text-orange-600">
                  {(thermodynamicData.reactantEnergy + thermodynamicData.activationEnergy * thermodynamicData.reactionProgress).toFixed(1)} kJ/mol
                </span>
              </div>
            </div>
        ...
        <div className="w-3/5 bg-white border border-gray-200 rounded-lg overflow-hidden">
