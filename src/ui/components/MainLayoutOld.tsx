...
export const MainLayout: React.FC<MainLayoutProps> = ({
  ...
  return (
    <div className={`h-screen flex flex-col font-sans ${themeClasses.background}`}>
      {/* Top Header */}
      <header
        className={`flex justify-between items-center px-5 py-3 ${themeClasses.card} border-b shadow-sm min-h-[60px]`}
      >
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        {/* Right Control Panel */}
        <aside
          className={`w-80 border-l overflow-y-auto flex flex-col ${themeClasses.card} flex-shrink-0`}
        >
          {/* Reaction Setup Section */}
          <section className="p-5 border-b border-gray-100">
            <h3
              className={`text-base font-semibold mb-4 flex items-center gap-2 ${themeClasses.text}`}
            >
              REACTION SETUP
            </h3>
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-xs font-medium mb-1 text-gray-500">Substrate:</label>
                  <select
                    value={substrate}
          ...
          <section className="p-5 border-b border-gray-100">
            <h3
              className={`text-base font-semibold mb-3 flex items-center gap-2 ${themeClasses.text}`}
            >
              🎯 ATTACK MODE
            </h3>
            <div className="space-y-3">
          ...
          <div className="lg:w-1/3 w-full">
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 h-full">
              ...
              <div className="mt-4 bg-green-50 border border-green-200 rounded p-3">
                ...
                <div className="text-xs text-green-600 mt-1">✅ Sufficient activation energy</div>
              </div>
            </div>
          </div>
