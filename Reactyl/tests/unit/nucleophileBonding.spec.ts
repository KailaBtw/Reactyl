...
describe('Nucleophile Bonding Behavior', () => {
  ...
  describe('Bond Formation', () => {
    ...
    it('nucleophile oxygen is positioned correctly for bonding', () => {
      ...
      setTimeout(() => {
        ...
        const oxygenAtom = nucleophile.group.children.find(
          (child: any) => child.userData.element === 'O'
        );
    ...
    it('maintains nucleophile structure during bonding', () => {
      ...
      setTimeout(() => {
        ...
        expect(
          nucleophile.group.children.some((child: any) => child.userData.element === 'O')
        ).toBe(true);
        expect(
          nucleophile.group.children.some((child: any) => child.userData.element === 'H')
        ).toBe(true);
      }, 1200);
    });
  });
  ...
  describe('Bonding Accuracy', () => {
    ...
    it('nucleophile maintains proper orientation during approach', () => {
      ...
      setTimeout(() => {
        ...
        const hydrogenAtom = nucleophile.group.children.find(
          (child: any) => child.userData.element === 'H'
        );
  ...
  describe('Error Handling', () => {
    it('handles nucleophile with no oxygen atom', () => {
      // Remove oxygen atom
      nucleophile.group.children = nucleophile.group.children.filter(
        (child: any) => child.userData.element !== 'O'
      );
