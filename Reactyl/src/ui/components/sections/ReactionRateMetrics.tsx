  ...
  return (
    <section className="p-5 border-b border-gray-200 dark:border-gray-700">
      ...
      <div className="space-y-4">
        ...
        <div
          className={`p-4 rounded-lg ${themeClasses.card} border-2 border-green-500/30 bg-gradient-to-br from-green-50 to-green-100/50 dark:from-green-950/30 dark:to-green-900/20`}
        >
          <div className="flex items-baseline justify-between mb-2">
            <span
              className={`text-xs font-medium uppercase tracking-wide ${themeClasses.textSecondary}`}
            >
              Reaction Rate
            </span>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className={`p-3 rounded-lg ${themeClasses.card} border border-green-500/20`}>
            <div className={`text-xs font-medium mb-1 ${themeClasses.textSecondary}`}>Products</div>
            <div className={`text-xl font-bold text-green-600 dark:text-green-400`}>
              {productsFormed}
            </div>
            <div className={`text-xs mt-1 ${themeClasses.textSecondary}`}>formed</div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-2">
          <div
            className={`p-3 rounded-lg ${themeClasses.card} border border-gray-300 dark:border-gray-600`}
          >
            <div className={`text-xs font-medium mb-1 ${themeClasses.textSecondary}`}>
              Collisions
            </div>
        ...
        {/* Elapsed Time */}
        <div
          className={`p-3 rounded-lg ${themeClasses.card} border border-gray-300 dark:border-gray-600 text-center`}
        >
          <div className={`text-xs font-medium mb-1 ${themeClasses.textSecondary}`}>
            Simulation Time
          </div>
