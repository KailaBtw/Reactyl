  ...
  const getThemeColors = () => {
    if (!themeClasses) {
      ...
      return {
        ...
        inactive:
          'bg-gradient-to-r from-gray-100 to-gray-200 text-gray-700 border-gray-300 hover:from-gray-200 hover:to-gray-300 hover:border-gray-400',
      };
    }
    ...
    if (buttonClasses.includes('blue')) {
      return {
        active:
          'bg-gradient-to-r from-blue-500 to-blue-600 text-white border-blue-500 shadow-blue-200',
        inactive:
          'bg-gradient-to-r from-gray-100 to-gray-200 text-gray-700 border-gray-300 hover:from-gray-200 hover:to-gray-300 hover:border-gray-400',
      };
      ...
      return {
        active:
          'bg-gradient-to-r from-emerald-500 to-emerald-600 text-white border-emerald-500 shadow-emerald-200',
        inactive:
          'bg-gradient-to-r from-gray-100 to-gray-200 text-gray-700 border-gray-300 hover:from-gray-200 hover:to-gray-300 hover:border-gray-400',
      };
      ...
      return {
        active:
          'bg-gradient-to-r from-violet-500 to-violet-600 text-white border-violet-500 shadow-violet-200',
        inactive:
          'bg-gradient-to-r from-gray-100 to-gray-200 text-gray-700 border-gray-300 hover:from-gray-200 hover:to-gray-300 hover:border-gray-400',
      };
      ...
      return {
        active:
          'bg-gradient-to-r from-gray-600 to-gray-700 text-white border-gray-600 shadow-gray-200',
        inactive:
          'bg-gradient-to-r from-gray-100 to-gray-200 text-gray-700 border-gray-300 hover:from-gray-200 hover:to-gray-300 hover:border-gray-400',
      };
    } else {
      ...
      return {
        active:
          'bg-gradient-to-r from-gray-400 to-gray-500 text-white border-gray-400 shadow-gray-200',
        inactive:
          'bg-gradient-to-r from-gray-100 to-gray-200 text-gray-700 border-gray-300 hover:from-gray-200 hover:to-gray-300 hover:border-gray-400',
      };
    }
