...
export const MOLECULAR_MASS_LOOKUP: { [key: string]: number } = {
  ...
  demo_Methyl_chloride: 0.05, // CH3Cl
 ...
 */
export function getMolecularMass(
  moleculeName: string,
  role: 'substrate' | 'nucleophile' | 'base' = 'substrate'
): number {
 ...
 */
export function getReactionMasses(
  substrate: string,
  nucleophile: string
): {
