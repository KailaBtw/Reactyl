...
describe('ReactionOrchestrator State Consistency', () => {
  ...
  it('prevents molecules not available warnings during reaction execution', async () => {
    ...
    const substrate: any = { name: 'Substrate', group: new THREE.Group(), velocity: new THREE.Vector3() };
    const nucleophile: any = { name: 'Nucleophile', group: new THREE.Group(), velocity: new THREE.Vector3() };
